...
/**
 * Rule to setup [GenZappStore] with a mock [KeyValueDataSet]. Must be used with Roboelectric.
 *
 ...
 */
class GenZappStoreRule @JvmOverloads constructor(private val defaultValues: KeyValueDataSet.() -> Unit = {}) : TestRule {
  ...
  override fun apply(base: Statement, description: Description): Statement {
    return object : Statement() {
      ...
      override fun evaluate() {
        ...
        GenZappStore.testInject(KeyValueStore(MockKeyValuePersistentStorage.withDataSet(dataSet)))
