...
import org.whispersystems.GenZappservice.internal.storage.protos.StoryDistributionListRecord
...
class StoryDistributionListRecordProcessorTest {
  ...
  fun `Given a proto without an identifier, when I isInvalid, then I expect true`() {
    ...
    val record = GenZappStoryDistributionListRecord(STORAGE_ID, proto)
