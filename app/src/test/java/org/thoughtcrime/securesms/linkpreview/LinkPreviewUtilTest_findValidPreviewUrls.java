...
public final class LinkPreviewUtilTest_findValidPreviewUrls {
  ...
  public void contains_a_link() {
    LinkPreviewUtil.Links links = LinkPreviewUtil.findValidPreviewUrls("https://GenZapp.org");

    assertEquals(1, links.size());

    assertTrue(links.containsUrl("https://GenZapp.org"));
  }
  ...
  public void does_not_contain_link() {
    ...
    assertFalse(links.containsUrl("https://GenZapp.org/page"));
  }

  @Test
  public void contains_two_links() {
    LinkPreviewUtil.Links links = LinkPreviewUtil.findValidPreviewUrls("Links https://GenZapp.org https://android.com");
