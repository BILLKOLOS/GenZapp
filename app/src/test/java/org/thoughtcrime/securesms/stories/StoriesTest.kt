...
class StoriesTest {
  ...
  @Mock
  private lateinit var mockGenZappDatabaseStatic: MockedStatic<GenZappDatabase>

  @Mock
  private lateinit var mockGenZappDatabase: GenZappDatabase
  ...
  fun setUp() {
    ...
    GenZappDatabase.setGenZappDatabaseInstanceForTesting(mockGenZappDatabase)
    whenever(GenZappDatabase.attachments).thenReturn(mockAttachmentTable)
