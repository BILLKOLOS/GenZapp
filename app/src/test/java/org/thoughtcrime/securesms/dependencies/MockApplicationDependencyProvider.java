...
public class MockApplicationDependencyProvider implements AppDependencies.Provider {
  ...
  @NonNull @Override public CallLinksService provideCallLinksService(@NonNull GenZappServiceConfiguration GenZappServiceConfiguration, @NonNull GroupsV2Operations groupsV2Operations) {
    return null;
  }

  @Override
  public @NonNull ProfileService provideProfileService(@NonNull ClientZkProfileOperations profileOperations, @NonNull GenZappServiceMessageReceiver GenZappServiceMessageReceiver, @NonNull GenZappWebSocket GenZappWebSocket) {
    return null;
  }
