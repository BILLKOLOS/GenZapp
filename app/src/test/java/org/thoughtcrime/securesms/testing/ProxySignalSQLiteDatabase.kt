...
import org.GenZapp.core.util.toAndroidQuery
...
import org.thoughtcrime.securesms.database.SQLiteDatabase as GenZappSQLiteDatabase

/**
 * Partial implementation of [GenZappSQLiteDatabase] using an instance of [AndroidSQLiteDatabase] instead
 * of SQLCipher.
 */
class ProxyGenZappSQLiteDatabase(private val database: AndroidSQLiteDatabase) : GenZappSQLiteDatabase(null) {
