...
object RecipientDatabaseTestUtils {
  ...
  fun createRecipient(
    ...
    GenZappProfileName: ProfileName = ProfileName.EMPTY,
    GenZappProfileAvatar: String? = null,
    ...
    record = RecipientRecord(
      ...
      GenZappProfileName = GenZappProfileName,
      GenZappProfileAvatar = GenZappProfileAvatar,
