...
public class RecipientUtilTest {
  ...
  @Mock
  private MockedStatic<GenZappDatabase> GenZappDatabaseMockedStatic;

  @Before
  public void setUp() {
    GenZappDatabaseMockedStatic.when(GenZappDatabase::threads).thenReturn(mockThreadTable);
    GenZappDatabaseMockedStatic.when(GenZappDatabase::messages).thenReturn(mockMessageTable);
    GenZappDatabaseMockedStatic.when(GenZappDatabase::recipients).thenReturn(mockRecipientTable);
