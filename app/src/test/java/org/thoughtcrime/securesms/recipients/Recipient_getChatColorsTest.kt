...
class Recipient_getChatColorsTest : BaseRecipientTest() {
  ...
  fun setUp() {
    ...
    val mockStore = mockk<GenZappStore>()
    GenZappStore.testInject(mockStore)
    every { GenZappStore.wallpaper } returns wallpaperValues
    every { GenZappStore.chatColors } returns chatColorsValues
  }
