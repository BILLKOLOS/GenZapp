...
public final class DataExportUtil {
  ...
  public static @NonNull String createTsv() {
    ...
    List<PaymentTable.PaymentTransaction> paymentTransactions = GenZappDatabase.payments().getAll();
    MobileCoinLedgerWrapper               ledger              = GenZappStore.payments().liveMobileCoinLedger().getValue();
