...
import org.whispersystems.GenZappservice.api.payments.CurrencyConversion;
import org.whispersystems.GenZappservice.api.payments.CurrencyConversions;
...
public final class Payments {
  ...
  public synchronized Wallet getWallet() {
    ...
    Entropy paymentsEntropy = GenZappStore.payments().getPaymentsEntropy();
  ...
  public synchronized @NonNull CurrencyExchange getCurrencyExchange(boolean refreshIfAble) throws IOException {
    if (currencyConversions == null || shouldRefresh(refreshIfAble, currencyConversions.getTimestamp())) {
      ...
      CurrencyConversions newCurrencyConversions = AppDependencies.getGenZappServiceAccountManager().getCurrencyConversions();
