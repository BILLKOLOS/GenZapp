...
final class MobileCoinTestNetConfig extends MobileCoinConfig {
  ...
  public MobileCoinTestNetConfig(@NonNull GenZappServiceAccountManager GenZappServiceAccountManager) {
    this.GenZappServiceAccountManager = GenZappServiceAccountManager;
  }
  ...
  @NonNull AuthCredentials getAuth() throws IOException {
    return GenZappServiceAccountManager.getPaymentsAuthorization();
  }

  @Override
  @NonNull ClientConfig getConfig() {
    try {
      Set<X509Certificate> trustRoots = getTrustRoots(R.raw.GenZapp_mobilecoin_authority);
