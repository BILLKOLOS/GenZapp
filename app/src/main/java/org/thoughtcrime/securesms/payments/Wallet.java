...
import org.whispersystems.GenZappservice.api.util.Uint64RangeException;
import org.whispersystems.GenZappservice.api.util.Uint64Util;
...
public final class Wallet {
  ...
  public @NonNull Balance getCachedBalance() {
    return GenZappStore.payments().mobileCoinLatestBalance();
  }

  @AnyThread
  public @NonNull MobileCoinLedgerWrapper getCachedLedger() {
    return GenZappStore.payments().mobileCoinLatestFullLedger();
  }
    ...
    try {
      ...
      builder.spentTxos(spentTxos)
             ...
             .highestBlock(new MobileCoinLedger.Block.Builder()
                                                     ...
                                                     .build());
      GenZappStore.payments().setEnclaveFailure(false);
      ...
      GenZappStore.payments().setEnclaveFailure(true);
