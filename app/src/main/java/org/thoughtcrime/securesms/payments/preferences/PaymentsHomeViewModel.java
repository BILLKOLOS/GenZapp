...
public class PaymentsHomeViewModel extends ViewModel {
                        ...
                        @NonNull CurrencyExchangeRepository currencyExchangeRepository)
  {
    ...
    this.balance                    = LiveDataUtil.mapDistinct(GenZappStore.payments().liveMobileCoinBalance(), Balance::getFullAmount);
    ...
    LiveData<CurrencyExchange.ExchangeRate> liveExchangeRate = LiveDataUtil.combineLatest(GenZappStore.payments().liveCurrentCurrency(),
  ...
  private static PaymentsHomeState.PaymentsState getPaymentsState() {
    PaymentsValues paymentsValues = GenZappStore.payments();
  ...
  void checkPaymentActivationState() {
    ...
    boolean                         paymentsEnabled = GenZappStore.payments().mobileCoinPaymentsEnabled();
