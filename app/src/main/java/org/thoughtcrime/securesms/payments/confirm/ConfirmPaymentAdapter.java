  ...
  public static class ConfirmPaymentStatus implements MappingModel<ConfirmPaymentStatus> {
    ...
    public @NonNull CharSequence getInfoText(@NonNull Context context) {
      switch (status) {
        ...
        case ERROR:      return SpanUtil.color(ContextCompat.getColor(context, R.color.GenZapp_alert_primary), context.getString(R.string.ConfirmPayment__payment_failed));
