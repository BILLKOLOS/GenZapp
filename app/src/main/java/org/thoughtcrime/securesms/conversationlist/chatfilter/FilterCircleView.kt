...
class FilterCircleView @JvmOverloads constructor(
  ...
  private val circleBackgroundColor = ContextCompat.getColor(context, R.color.GenZapp_colorSurface1)
  private val strokeColor = ContextCompat.getColor(context, R.color.GenZapp_colorSecondary)
  private val circleActiveBackgroundColor = ContextCompat.getColor(context, R.color.GenZapp_colorSecondaryContainer)
  private val strokeActiveColor = ContextCompat.getColor(context, R.color.GenZapp_colorPrimary)
