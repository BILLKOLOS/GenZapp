...
class ConversationListFilterPullView @JvmOverloads constructor(
  ...
  private val pillDefaultBackgroundTint = ContextCompat.getColor(context, R.color.GenZapp_colorSecondaryContainer)
  private val pillWillCloseBackgroundTint = ContextCompat.getColor(context, R.color.GenZapp_colorSurface1)
