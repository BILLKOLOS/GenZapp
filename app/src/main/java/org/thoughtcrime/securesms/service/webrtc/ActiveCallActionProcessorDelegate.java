...
import org.GenZapp.ringrtc.CallManager.CallEvent;
...
public class ActiveCallActionProcessorDelegate extends WebRtcActionProcessor {
  ...
  protected @NonNull WebRtcServiceState handleLocalHangup(@NonNull WebRtcServiceState currentState) {
    ...
    AppDependencies.getGenZappServiceAccountManager().cancelInFlightRequests();
    AppDependencies.getGenZappServiceMessageSender().cancelInFlightRequests();
                                                          ...
                                                          @NonNull RemotePeer remotePeer)
  {
    ...
    if (endedRemoteEvent == CallEvent.ENDED_REMOTE_HANGUP || endedRemoteEvent == CallEvent.ENDED_REMOTE_HANGUP_BUSY) {
      ...
      ThreadUtil.runOnMainDelayed(ringer::stop, GenZappCallManager.BUSY_TONE_LENGTH);
