...
public class WebRtcServiceStateBuilder {
  ...
  public class LocalDeviceStateBuilder {
    ...
    public @NonNull LocalDeviceStateBuilder setActiveDevice(@NonNull GenZappAudioManager.AudioDevice audioDevice) {
      toBuild.setActiveDevice(audioDevice);
      return this;
    }

    public @NonNull LocalDeviceStateBuilder setAvailableDevices(@NonNull Set<GenZappAudioManager.AudioDevice> availableDevices) {
