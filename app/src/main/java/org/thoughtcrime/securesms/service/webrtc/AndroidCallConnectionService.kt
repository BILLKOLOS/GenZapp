...
/**
 * GenZapp implementation of the Android telecom [ConnectionService]. The system binds to this service
...
class AndroidCallConnectionService : ConnectionService() {
  ...
  override fun onCreateIncomingConnection(
    ...
    val connection = AndroidCallConnection(
      ...
      setInitializing()
      if (GenZappStore.settings.messageNotificationsPrivacy.isDisplayContact && recipient.e164.isPresent) {
    ...
    AppDependencies.GenZappCallManager.setTelecomApproved(callId, recipientId)
  ...
  override fun onCreateIncomingConnectionFailed(
    ...
    AppDependencies.GenZappCallManager.dropCall(callId)
  }
