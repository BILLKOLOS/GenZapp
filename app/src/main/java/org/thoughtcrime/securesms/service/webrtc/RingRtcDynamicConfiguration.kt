...
import org.GenZapp.core.util.asListContains
import org.GenZapp.ringrtc.CallManager.AudioProcessingMethod
...
object RingRtcDynamicConfiguration {
  ...
  fun getAudioProcessingMethod(): AudioProcessingMethod {
    if (GenZappStore.internal.callingAudioProcessingMethod() != AudioProcessingMethod.Default) {
      return GenZappStore.internal.callingAudioProcessingMethod()
    }
