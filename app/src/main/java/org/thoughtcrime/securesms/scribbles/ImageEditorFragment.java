...
import org.GenZapp.core.util.FontUtil;
import org.GenZapp.core.util.concurrent.GenZappExecutors;
import org.GenZapp.core.util.concurrent.SimpleTask;
import org.GenZapp.core.util.logging.Log;
import org.GenZapp.imageeditor.core.Bounds;
import org.GenZapp.imageeditor.core.ColorableRenderer;
import org.GenZapp.imageeditor.core.ImageEditorView;
import org.GenZapp.imageeditor.core.Renderer;
import org.GenZapp.imageeditor.core.SelectableRenderer;
import org.GenZapp.imageeditor.core.model.EditorElement;
import org.GenZapp.imageeditor.core.model.EditorModel;
import org.GenZapp.imageeditor.core.renderers.BezierDrawingRenderer;
import org.GenZapp.imageeditor.core.renderers.FaceBlurRenderer;
import org.GenZapp.imageeditor.core.renderers.MultiLineTextRenderer;
                                                                   ...
                                                                   TextEntryDialogFragment.Controller
{
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    @ColorInt int blackoutColor = ContextCompat.getColor(requireContext(), R.color.GenZapp_colorBackground);
    if (editorModel == null) {
      switch (mode) {
        case AVATAR_EDIT:
    ...
    if (!GenZappStore.tooltips().hasSeenBlurHudIconTooltip()) {
      imageEditorHud.showBlurHudTooltip();
      GenZappStore.tooltips().markBlurHudIconTooltipSeen();
    }
  ...
  private void performSaveToDisk() {
    SimpleTask.run(this::renderToSingleUseBlob, uri -> {
      ...
      saveTask.executeOnExecutor(GenZappExecutors.BOUNDED, attachment);
    });
  }
