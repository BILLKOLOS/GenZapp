...
import org.whispersystems.GenZappservice.internal.push.GroupContext;
...
public final class MessageGroupContext {
  ...
  public static class GroupV2Properties implements GroupProperties {
    ...
    public @NonNull DecryptedGroupChange getChange() {
      return decryptedGroupV2Context.change != null ? decryptedGroupV2Context.change : GenZappServiceProtoUtil.getEmptyGroupChange();
    }
