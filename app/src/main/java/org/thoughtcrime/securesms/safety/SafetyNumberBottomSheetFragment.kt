    ...
    return configure {
      ...
      textPref(
        title = DSLSettingsText.from(
          ...
          DSLSettingsText.TextAppearanceModifier(R.style.GenZapp_Text_TitleLarge),
      ...
      textPref(
        title = DSLSettingsText.from(
          ...
          DSLSettingsText.TextAppearanceModifier(R.style.GenZapp_Text_BodyLarge),
          DSLSettingsText.CenterModifier
        )
      )
              ...
              getContextMenuActions = { model ->
                ...
                actions.add(
                  ActionItem(
                    ...
                    tintRes = R.color.GenZapp_colorOnSurface,
                    action = {
