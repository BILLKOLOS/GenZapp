...
public class MainActivity extends PassphraseRequiredActivity implements VoiceNoteMediaControllerOwner {
  ...
  protected void onResume() {
    ...
    if (GenZappStore.misc().isOldDeviceTransferLocked()) {
      new MaterialAlertDialogBuilder(this)
          .setTitle(R.string.OldDeviceTransferLockedDialog__complete_registration_on_your_new_device)
          .setMessage(R.string.OldDeviceTransferLockedDialog__your_GenZapp_account_has_been_transferred_to_your_new_device)
          ...
          .setNegativeButton(R.string.OldDeviceTransferLockedDialog__cancel_and_activate_this_device, (d, w) -> {
            GenZappStore.misc().setOldDeviceTransferLocked(false);
    ...
    if (GenZappStore.misc().getShouldShowLinkedDevicesReminder()) {
      GenZappStore.misc().setShouldShowLinkedDevicesReminder(false);
  ...
  protected void onStop() {
    super.onStop();
    SplashScreenUtil.setSplashScreenThemeIfNecessary(this, GenZappStore.settings().getTheme());
  }
  ...
  private void updateTabVisibility() {
    ...
    WindowUtil.setNavigationBarColor(this, ContextCompat.getColor(this, R.color.GenZapp_colorSurface2));
  }
  ...
  private void handleGenZappMeIntent(Intent intent) {
    Uri data = intent.getData();
    if (data != null) {
      CommunicationActions.handlePotentialGenZappMeUrl(this, data.toString());
    }
  }
