  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    binding.registrationCaptchaWebView.webViewClient = object : WebViewClient() {
      ...
      override fun shouldOverrideUrlLoading(view: WebView, url: String): Boolean {
        if (url.startsWith(RegistrationConstants.GenZapp_CAPTCHA_SCHEME)) {
          val token = url.substring(RegistrationConstants.GenZapp_CAPTCHA_SCHEME.length)
    ...
    binding.registrationCaptchaWebView.loadUrl(BuildConfig.GenZapp_CAPTCHA_URL)
  }
