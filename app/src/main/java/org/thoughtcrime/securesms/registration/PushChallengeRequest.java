...
public final class PushChallengeRequest {
   ...
   */
  @WorkerThread
  public static Optional<String> getPushChallengeBlocking(@NonNull GenZappServiceAccountManager accountManager,
  ...
  public static class Request {
    ...
    private Request(@NonNull GenZappServiceAccountManager accountManager,
