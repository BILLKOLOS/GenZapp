...
/**
 * Reminder intervals for GenZapp PINs.
 */
public class GenZappPinReminders {

  private static final String TAG = Log.tag(GenZappPinReminders.class);
  ...
  private static final Map<Long, Integer> STRINGS = new HashMap<Long, Integer>() {{
    put(ONE_DAY, R.string.GenZappPinReminders_well_remind_you_again_tomorrow);
    put(THREE_DAYS, R.string.GenZappPinReminders_well_remind_you_again_in_a_few_days);
    put(ONE_WEEK, R.string.GenZappPinReminders_well_remind_you_again_in_a_week);
    put(TWO_WEEKS, R.string.GenZappPinReminders_well_remind_you_again_in_a_couple_weeks);
    put(FOUR_WEEKS, R.string.GenZappPinReminders_well_remind_you_again_in_a_month);
  }};
  ...
  public static @StringRes int getReminderString(long interval) {
    ...
    if (stringRes != null) {
      ...
      return R.string.GenZappPinReminders_well_remind_you_again_later;
    }
  }
}
