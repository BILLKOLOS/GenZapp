...
class MessageBackupsFlowFragment : ComposeFragment(), InAppPaymentCheckoutDelegate.Callback {
  ...
  private fun cancelSubscription() {
    findNavController().safeNavigate(
      MessageBackupsFlowFragmentDirections.actionDonateToGenZappFragmentToStripePaymentInProgressFragment(
  ...
  override fun navigateToPayPalPaymentInProgress(inAppPayment: InAppPaymentTable.InAppPayment) {
    findNavController().safeNavigate(
      MessageBackupsFlowFragmentDirections.actionDonateToGenZappFragmentToPaypalPaymentInProgressFragment(
        InAppPaymentProcessorAction.PROCESS_NEW_IN_APP_PAYMENT,
        inAppPayment,
        inAppPayment.type
      )
  ...
  override fun navigateToCreditCardForm(inAppPayment: InAppPaymentTable.InAppPayment) {
    findNavController().safeNavigate(
      MessageBackupsFlowFragmentDirections.actionDonateToGenZappFragmentToCreditCardFragment(inAppPayment)
    )
  }

  override fun navigateToIdealDetailsFragment(inAppPayment: InAppPaymentTable.InAppPayment) {
    findNavController().safeNavigate(
      MessageBackupsFlowFragmentDirections.actionDonateToGenZappFragmentToIdealTransferDetailsFragment(inAppPayment)
    )
  }

  override fun navigateToBankTransferMandate(inAppPayment: InAppPaymentTable.InAppPayment) {
    findNavController().safeNavigate(
      MessageBackupsFlowFragmentDirections.actionDonateToGenZappFragmentToBankTransferMandateFragment(inAppPayment)
    )
  }
