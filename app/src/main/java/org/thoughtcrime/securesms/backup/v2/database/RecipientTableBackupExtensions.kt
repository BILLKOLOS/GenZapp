...
import org.GenZapp.core.util.requireNonNullBlob
...
import org.GenZapp.storageservice.protos.groups.local.DecryptedBannedMember
...
import org.GenZapp.storageservice.protos.groups.local.EnabledState
...
fun RecipientTable.restoreReleaseNotes(): RecipientId {
  ...
  GenZappStore.releaseChannel.setReleaseChannelRecipientId(releaseChannelId)

  setProfileName(releaseChannelId, ProfileName.asGiven("GenZapp"))
...
fun RecipientTable.restoreGroupFromBackup(group: Group): RecipientId {
  ...
  val restoredId = GenZappDatabase.groups.create(masterKey, decryptedState, groupSendEndorsements = null)
  if (restoredId != null) {
    GenZappDatabase.groups.setShowAsStoryState(restoredId, group.storySendMode.toGroupShowAsStoryState())
  }
