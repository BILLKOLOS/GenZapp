  ...
  Scaffolds.Settings(
    ...
    Column(
      ...
      LazyColumn(
        ...
        item {
          Image(
            painter = painterResource(id = R.drawable.ic_GenZapp_logo_large), // TODO [message-backups] Final image asset
        ...
        item {
          Text(
            text = stringResource(id = R.string.RemoteBackupsSettingsFragment__GenZapp_backups),
  ...
  Row(
    ...
    Icon(
      ...
      modifier = Modifier
        .padding(end = 8.dp)
        .size(32.dp)
        .background(color = GenZappTheme.colors.colorSurface2, shape = CircleShape)
        .padding(6.dp)
    )
