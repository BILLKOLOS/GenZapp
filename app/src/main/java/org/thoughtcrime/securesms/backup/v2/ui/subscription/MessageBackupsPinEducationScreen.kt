...
fun MessageBackupsPinEducationScreen(
  ...
  Scaffolds.Settings(
    title = stringResource(id = R.string.RemoteBackupsSettingsFragment__GenZapp_backups),
    ...
    Column(
      ...
      LazyColumn(
        ...
        item {
          Image(
            painter = painterResource(id = R.drawable.ic_GenZapp_logo_large), // TODO [message-backups] Finalized image
        ...
        item {
          Text(
            text = stringResource(id = R.string.MessageBackupsPinEducationScreen__your_GenZapp_pin_lets_you),
      ...
      Buttons.LargePrimary(
        ...
        Text(
          text = stringResource(id = R.string.MessageBackupsPinEducationScreen__use_current_GenZapp_pin)
        )
      }
