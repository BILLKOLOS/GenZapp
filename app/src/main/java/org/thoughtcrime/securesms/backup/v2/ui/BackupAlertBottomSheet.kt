...
import org.GenZapp.core.ui.Icons
...
private fun MediaBackupsAreOffBody(
  ...
  Text(
    text = pluralStringResource(id = R.plurals.BackupAlertBottomSheet__your_GenZapp_media_backup_plan, daysUntilDeletion.toInt(), daysUntilDeletion),
    textAlign = TextAlign.Center,
...
private fun MediaWillBeDeletedTodayBody() {
  Text(
    text = stringResource(id = R.string.BackupAlertBottomSheet__your_GenZapp_media_backup_plan_has_been),
    textAlign = TextAlign.Center,
    modifier = Modifier.padding(bottom = 24.dp)
  )
