 ...
 */
abstract class DefaultStorageRecordProcessor<E extends GenZappRecord> implements StorageRecordProcessor<E>, Comparator<E> {
   ...
   * general we rely on GenZappRecords to implement an equals() that includes the StorageId, so using
  ...
  /**
   * Only records that pass the validity check (i.e. return false from {@link #isInvalid(GenZappRecord)}
