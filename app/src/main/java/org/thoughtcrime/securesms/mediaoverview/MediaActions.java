...
final class MediaActions {
                              ...
                              @Nullable Runnable postExecute)
  {
    ...
    SaveAttachmentTask.showWarningDialog(context, (dialogInterface, which) -> Permissions.with(fragment)
                      ...
                      .ifNecessary()
                      .withPermanentDenialDialog(fragment.getString(R.string.MediaPreviewActivity_GenZapp_needs_the_storage_permission_in_order_to_write_to_external_storage_but_it_has_been_permanently_denied))
