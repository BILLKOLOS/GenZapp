...
public class StorageForcePushJob extends BaseJob {
  ...
  protected void onRun() throws IOException, RetryLaterException {
    ...
    UnknownStorageIdTable       storageIdTable    = GenZappDatabase.unknownStorageIds();
    ...
    List<GenZappStorageRecord>   inserts              = Stream.of(oldContactStorageIds.keySet())
    ...
    GenZappStorageRecord accountRecord    = StorageSyncHelper.buildAccountRecord(context, Recipient.self().fresh());
    ...
    GenZappStorageManifest manifest = new GenZappStorageManifest(newVersion, GenZappStore.account().getDeviceId(), allNewStorageIds);
    ...
    GenZappStore.storageService().setManifest(manifest);
