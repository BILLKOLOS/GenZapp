...
public class SendReadReceiptJob extends BaseJob {
  ...
  public void onRun() throws IOException, UntrustedIdentityException, UndeliverableMessageException {
    ...
    GenZappServiceReceiptMessage receiptMessage = new GenZappServiceReceiptMessage(GenZappServiceReceiptMessage.Type.READ, messageSentTimestamps, timestamp);
    ...
    if (Util.hasItems(messageIds)) {
      GenZappDatabase.messageLog().insertIfPossible(recipientId, timestamp, result, ContentHint.IMPLICIT, messageIds, false);
    }
  }
