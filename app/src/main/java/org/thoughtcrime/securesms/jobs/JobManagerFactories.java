...
import org.thoughtcrime.securesms.migrations.CopyUsernameToGenZappStoreMigrationJob;
...
public final class JobManagerFactories {
  ...
  public static Map<String, Job.Factory> getJobFactories(@NonNull Application application) {
    return new HashMap<String, Job.Factory>() {{
      ...
      put(CopyUsernameToGenZappStoreMigrationJob.KEY, new CopyUsernameToGenZappStoreMigrationJob.Factory());
  ...
  public static List<JobMigration> getJobMigrations(@NonNull Application application) {
    return Arrays.asList(new RecipientIdJobMigration(application),
                         ...
                         new SendReadReceiptsJobMigration(GenZappDatabase.messages()),
