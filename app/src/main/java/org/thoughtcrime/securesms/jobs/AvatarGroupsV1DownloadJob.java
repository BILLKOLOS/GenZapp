...
public final class AvatarGroupsV1DownloadJob extends BaseJob {
  ...
  public void onRun() throws IOException {
    GroupTable            database = GenZappDatabase.groups();
    ...
    try {
      if (record.isPresent()) {
        ...
        GenZappServiceAttachmentPointer pointer     = new GenZappServiceAttachmentPointer(0, new GenZappServiceAttachmentRemoteId.V2(avatarId), contentType, key, Optional.of(0), Optional.empty(), 0, 0, digest, Optional.empty(), 0, fileName, false, false, false, Optional.empty(), Optional.empty(), System.currentTimeMillis(), null);
        ...
        GenZappDatabase.groups().onAvatarUpdated(groupId, true);
