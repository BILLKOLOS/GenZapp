...
import org.whispersystems.GenZappservice.api.messages.multidevice.ViewedMessage;
...
public class MultiDeviceViewedUpdateJob extends BaseJob {
  ...
  public void onRun() throws IOException, UntrustedIdentityException {
    ...
    messageSender.sendSyncMessage(GenZappServiceSyncMessage.forViewed(viewedMessages));
  }
