...
import org.whispersystems.GenZappservice.api.crypto.protos.EnvelopeMetadata as EnvelopeMetadataProto
...
class PushProcessMessageJob private constructor(
  ...
  companion object {
    ...
    fun processOrDefer(messageProcessor: MessageContentProcessor, result: MessageDecryptor.Result.Success, localReceiveMetric: GenZappLocalMetrics.MessageReceive): PushProcessMessageJob? {
