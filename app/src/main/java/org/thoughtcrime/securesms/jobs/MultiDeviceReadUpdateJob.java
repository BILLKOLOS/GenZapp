...
import org.whispersystems.GenZappservice.api.messages.multidevice.ReadMessage;
...
public class MultiDeviceReadUpdateJob extends BaseJob {
  ...
  public void onRun() throws IOException, UntrustedIdentityException {
    ...
    messageSender.sendSyncMessage(GenZappServiceSyncMessage.forRead(readMessages));
  }
