...
import org.whispersystems.GenZappservice.api.messages.GenZappServiceTypingMessage.Action;
...
public class TypingSendJob extends BaseJob {
  ...
  public void onRun() throws Exception {
    ...
    if (!recipient.isRegistered()) {
      Log.w(TAG, "Not sending typing indicators to non-GenZapp recipients.");
      return;
    }
    ...
    GenZappServiceTypingMessage typingMessage = new GenZappServiceTypingMessage(typing ? Action.STARTED : Action.STOPPED, System.currentTimeMillis(), groupId);
