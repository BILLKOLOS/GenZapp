...
import org.GenZapp.core.util.getAllTables
import org.GenZapp.core.util.logTime
...
class AnalyzeDatabaseJob private constructor(
  ...
  override fun run(): Result {
    val tables = GenZappDatabase.rawDatabase.getAllTables()
      .sorted()
    ...
    logTime(TAG, "analyze-$table", decimalPlaces = 2) {
      GenZappDatabase.rawDatabase.rawQuery("PRAGMA analysis_limit=1000")
      GenZappDatabase.rawDatabase.rawQuery("ANALYZE $table")
    }
