...
import org.whispersystems.GenZappservice.api.messages.multidevice.ViewOnceOpenMessage;
...
public class MultiDeviceViewOnceOpenJob extends BaseJob {
  ...
  public void onRun() throws IOException, UntrustedIdentityException {
    ...
    messageSender.sendSyncMessage(GenZappServiceSyncMessage.forViewOnceOpen(openMessage));
  }
