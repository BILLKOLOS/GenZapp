...
class BackupRestoreJob private constructor(parameters: Parameters) : BaseJob(parameters) {
  ...
  override fun onAdded() {
    GenZappStore.backup.restoreState = RestoreState.PENDING
  }
  ...
  private fun restore(controller: BackupProgressService.Controller) {
    GenZappStore.backup.restoreState = RestoreState.RESTORING_DB
    ...
    GenZappStore.backup.restoreState = RestoreState.RESTORING_MEDIA
  }
