...
import org.thoughtcrime.securesms.databinding.AllGenZappConnectionsRowItemBinding
...
/**
 * AllGenZappConnections privacy setting row item with "View" support
 */
object AllGenZappConnectionsRowItem {

  private const val IS_CHECKED = 0
  private const val IS_COUNT = 1

  fun register(mappingAdapter: MappingAdapter) {
    mappingAdapter.registerFactory(Model::class.java, BindingFactory(::ViewHolder, AllGenZappConnectionsRowItemBinding::inflate))
  }
  ...
  private class ViewHolder(binding: AllGenZappConnectionsRowItemBinding) : BindingViewHolder<Model, AllGenZappConnectionsRowItemBinding>(binding) {
