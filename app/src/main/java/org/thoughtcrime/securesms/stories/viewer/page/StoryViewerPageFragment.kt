...
class StoryViewerPageFragment :
  ...
  private fun presentBottomBar(post: StoryPost, replyState: StoryViewerPageState.ReplyState, isReceiptsEnabled: Boolean) {
    ...
    viewsAndReplies.iconTint = ColorStateList.valueOf(ContextCompat.getColor(requireContext(), R.color.GenZapp_colorOnSurface))
    ...
    if (sendingProgressDrawable == null) {
      sendingProgressDrawable = IndeterminateDrawable.createCircularDrawable(
        ...
        CircularProgressIndicatorSpec(requireContext(), null).apply {
          ...
          indicatorColors = intArrayOf(ContextCompat.getColor(requireContext(), R.color.GenZapp_dark_colorNeutralInverse))
          trackThickness = 2.dp
        }
      ).apply {
  ...
  private fun presentPartialSendBottomBar() {
    ...
    viewsAndReplies.iconTint = ColorStateList.valueOf(ContextCompat.getColor(requireContext(), R.color.GenZapp_light_colorError))
