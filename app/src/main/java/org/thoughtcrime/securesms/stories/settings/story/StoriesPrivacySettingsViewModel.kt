...
class StoriesPrivacySettingsViewModel(
  ...
  private val store = RxStore(
    StoriesPrivacySettingsState(
      ...
      areViewReceiptsEnabled = GenZappStore.story.viewedReceiptsEnabled
    )
  )
  ...
  fun toggleViewReceipts() {
    GenZappStore.story.viewedReceiptsEnabled = !GenZappStore.story.viewedReceiptsEnabled
    store.update { it.copy(areViewReceiptsEnabled = GenZappStore.story.viewedReceiptsEnabled) }
