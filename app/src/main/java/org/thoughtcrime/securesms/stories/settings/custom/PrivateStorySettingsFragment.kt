...
class PrivateStorySettingsFragment : DSLSettingsFragment(
  ...
  private fun getConfiguration(state: PrivateStorySettingsState): DSLConfiguration {
    ...
    return configure {
      ...
      dividerPref()
      clickPref(
        title = DSLSettingsText.from(R.string.PrivateStorySettingsFragment__delete_custom_story, DSLSettingsText.ColorModifier(ContextCompat.getColor(requireContext(), R.color.GenZapp_alert_primary))),
        onClick = {
