...
class ChatColorsTable(context: Context, databaseHelper: GenZappDatabase) : DatabaseTable(context, databaseHelper) {
  ...
  private fun insertChatColors(chatColors: ChatColors): ChatColors {
    ...
    val db: SQLiteDatabase = databaseHelper.GenZappWritableDatabase
  ...
  private fun updateChatColors(chatColors: ChatColors): ChatColors {
    ...
    if (GenZappStore.chatColors.chatColors?.id == chatColors.id) {
      GenZappStore.chatColors.chatColors = chatColors
    }

    GenZappDatabase.recipients.onUpdatedChatColors(chatColors)
    notifyListeners()
  ...
  fun deleteChatColors(chatColors: ChatColors) {
    ...
    GenZappDatabase.recipients.onDeletedChatColors(chatColors)
    notifyListeners()
  }
