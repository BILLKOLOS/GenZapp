...
public class StickerTable extends DatabaseTable {
  ...
  public StickerTable(Context context, GenZappDatabase databaseHelper, AttachmentSecret attachmentSecret) {
  ...
  public void insertSticker(@NonNull IncomingSticker sticker, @NonNull InputStream dataStream, boolean notify) throws IOException {
    ...
    long id = databaseHelper.getGenZappWritableDatabase().insert(TABLE_NAME, null, contentValues);
    if (id == -1) {
      ...
      id = databaseHelper.getGenZappWritableDatabase().update(TABLE_NAME, contentValues, selection, args);
    }
  ...
  public @Nullable StickerRecord getSticker(@NonNull String packId, int stickerId, boolean isCover) {
    ...
    try (Cursor cursor = databaseHelper.getGenZappReadableDatabase().query(TABLE_NAME, null, selection, args, null, null, "1")) {
  ...
  public @Nullable StickerPackRecord getStickerPack(@NonNull String packId) {
    ...
    try (Cursor cursor = databaseHelper.getGenZappReadableDatabase().query(TABLE_NAME, null, query, args, null, null, null, "1")) {
  ...
  public @Nullable Cursor getInstalledStickerPacks() {
    ...
    return databaseHelper.getGenZappReadableDatabase().query(TABLE_NAME, null, selection, args, null, null, PACK_ORDER + " ASC");
  }
  ...
  public @Nullable Cursor getStickersByEmoji(@NonNull String emoji) {
    ...
    return databaseHelper.getGenZappReadableDatabase().query(TABLE_NAME, null, selection, args, null, null, null);
  }
  ...
  public @Nullable Cursor getAllStickerPacks(@Nullable String limit) {
    ...
    return databaseHelper.getGenZappReadableDatabase().query(TABLE_NAME, null, query, args, null, null, PACK_ORDER + " ASC", limit);
  }

  public @Nullable Cursor getStickersForPack(@NonNull String packId) {
    SQLiteDatabase db        = databaseHelper.getGenZappReadableDatabase();
  ...
  public @Nullable InputStream getStickerStream(long rowId) throws IOException {
    ...
    try (Cursor cursor = databaseHelper.getGenZappReadableDatabase().query(TABLE_NAME, null, selection, args, null, null, null)) {
  ...
  public void updateStickerLastUsedTime(long rowId, long lastUsed) {
    ...
    databaseHelper.getGenZappWritableDatabase().update(TABLE_NAME, values, selection, args);
  ...
  public void markPackAsInstalled(@NonNull String packKey, boolean notify) {
    updatePackInstalled(databaseHelper.getGenZappWritableDatabase(), packKey, true, notify);
    notifyStickerPackListeners();
  }
