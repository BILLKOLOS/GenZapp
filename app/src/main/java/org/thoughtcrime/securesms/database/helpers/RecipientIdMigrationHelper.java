  ...
  public static void execute(SQLiteDatabase db) {
    ...
    try (Cursor cursor = db.query("recipient_preferences", null, null, null, null, null, null)) {
      while (cursor != null && cursor.moveToNext()) {
        ...
        values.put("GenZapp_profile_name", cursor.getString(cursor.getColumnIndexOrThrow("GenZapp_profile_name")));
        values.put("GenZapp_profile_avatar", cursor.getString(cursor.getColumnIndexOrThrow("GenZapp_profile_avatar")));
