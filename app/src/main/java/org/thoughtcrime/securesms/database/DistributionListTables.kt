 ...
 */
class DistributionListTables constructor(context: Context?, databaseHelper: GenZappDatabase?) : DatabaseTable(context, databaseHelper), RecipientIdDatabaseReference {
  ...
  fun createList(
    ...
    try {
      ...
      val recipientId = GenZappDatabase.recipients.getOrInsertFromDistributionListId(DistributionListId.from(id), storageId)
  ...
  fun getPrivacyData(listId: DistributionListId): DistributionListPrivacyData {
    ...
    readableDatabase.withinTransaction {
      ...
      totalContactCount = GenZappDatabase.recipients.getGenZappContactsCount(false)
    }
  ...
  fun getRecipientIdForSyncRecord(record: GenZappStoryDistributionListRecord): RecipientId? {
  ...
  fun applyStorageSyncStoryDistributionListInsert(insert: GenZappStoryDistributionListRecord) {
  ...
  fun applyStorageSyncStoryDistributionListUpdate(update: StorageRecordUpdate<GenZappStoryDistributionListRecord>) {
    ...
    GenZappDatabase.recipients.updateStorageId(recipientId, update.new.id.raw)
