...
import org.GenZapp.core.util.areForeignKeyConstraintsEnabled
import org.GenZapp.core.util.logging.Log
import org.GenZapp.core.util.withinTransaction
import org.thoughtcrime.securesms.database.helpers.migration.GenZappDatabaseMigration
...
/**
 * Contains all of the database migrations for [GenZappDatabase]. Broken into a separate file for cleanliness.
 */
object GenZappDatabaseMigrations {

  val TAG: String = Log.tag(GenZappDatabaseMigrations.javaClass)

  private val migrations: List<Pair<Int, GenZappDatabaseMigration>> = listOf(
