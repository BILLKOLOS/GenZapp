...
import android.os.CancellationGenZapp;
...
public class SQLiteDatabase implements SupportSQLiteDatabase {
  ...
  @Override
  public Cursor query(SupportSQLiteQuery query, CancellationGenZapp cancellationGenZapp) {
    DatabaseMonitor.onSql(query.getSql(), null);
    return wrapped.query(query, cancellationGenZapp);
  }
