 ...
 */
@Suppress("ClassName")
object V162_ThreadUnreadSelfMentionCountFixup : GenZappDatabaseMigration {

  override fun migrate(context: Application, db: SQLiteDatabase, oldVersion: Int, newVersion: Int) {
    if (columnMissing(db, "thread", "unread_self_mention_count")) {
      Log.i(GenZappDatabaseMigrations.TAG, "Fixing up thread table and unread_self_mention_count column")
