 ...
 */
class RemappedRecordTables internal constructor(context: Context?, databaseHelper: GenZappDatabase?) : DatabaseTable(context, databaseHelper) {
  ...
  private fun addMapping(table: String, mapping: Mapping) {
    ...
    databaseHelper.GenZappWritableDatabase.insert(table, null, values)
  }
