...
public class SQLCipherMigrationHelper {
                                      ...
                                      @NonNull SQLiteDatabase modernDb)
  {
    ...
    try (NotificationController controller = GenericForegroundService.startForegroundTask(context, context.getString(R.string.SQLCipherMigrationHelper_migrating_GenZapp_database))) {
