...
import org.GenZapp.core.util.optionalBlob
import org.GenZapp.core.util.optionalBoolean
import org.GenZapp.core.util.optionalInt
import org.GenZapp.core.util.optionalLong
...
object RecipientTableCursorUtil {
  ...
  fun getRecord(context: Context, cursor: Cursor, idColumnName: String): RecipientRecord {
    ...
    return RecipientRecord(
      ...
      GenZappProfileName = ProfileName.fromParts(cursor.requireString(RecipientTable.PROFILE_GIVEN_NAME), cursor.requireString(RecipientTable.PROFILE_FAMILY_NAME)),
      GenZappProfileAvatar = cursor.requireString(RecipientTable.PROFILE_AVATAR),
