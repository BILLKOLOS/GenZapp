 ...
 */
class StorySendTable(context: Context, databaseHelper: GenZappDatabase) : DatabaseTable(context, databaseHelper), RecipientIdDatabaseReference {
  ...
  fun applySentStoryManifest(remoteManifest: SentStorySyncManifest, sentTimestamp: Long) {
    writableDatabase.withinTransaction {
      ...
      messagesWithoutAnyReceivers.forEach {
        GenZappDatabase.messages.markAsRemoteDelete(it)
        GenZappDatabase.messages.deleteRemotelyDeletedStory(it)
      }
    }
  }
