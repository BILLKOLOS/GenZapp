...
public abstract class DatabaseTable {
  ...
  protected       GenZappDatabase databaseHelper;
  ...
  public DatabaseTable(Context context, GenZappDatabase databaseHelper) {
  ...
  public void reset(GenZappDatabase databaseHelper) {
    this.databaseHelper = databaseHelper;
  }

  public SQLiteDatabase getReadableDatabase() {
    return databaseHelper.getGenZappReadableDatabase();
  }

  public SQLiteDatabase getWritableDatabase() {
    return databaseHelper.getGenZappWritableDatabase();
  }
}
