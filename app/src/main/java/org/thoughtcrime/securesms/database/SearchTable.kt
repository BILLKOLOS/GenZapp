...
class SearchTable(context: Context, databaseHelper: GenZappDatabase) : DatabaseTable(context, databaseHelper) {
  companion object {
  ...
  fun rebuildIndex(batchSize: Long = 10_000L) {
    val maxId: Long = GenZappDatabase.messages.getNextId()
