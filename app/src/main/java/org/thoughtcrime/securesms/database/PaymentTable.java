...
import org.GenZapp.core.util.CursorExtensionsKt;
import org.GenZapp.core.util.CursorUtil;
import org.GenZapp.core.util.SQLiteDatabaseExtensionsKt;
...
public final class PaymentTable extends DatabaseTable implements RecipientIdDatabaseReference {
  ...
  private final MutableLiveData<Object> changeGenZapp;

  PaymentTable(@NonNull Context context, @NonNull GenZappDatabase databaseHelper) {
    super(context, databaseHelper);

    this.changeGenZapp = new MutableLiveData<>(new Object());
  }
      ...
      throws PublicKeyConflictException, SerializationException
  {
    ...
    SQLiteDatabase database = databaseHelper.getGenZappWritableDatabase();
  ...
  public @NonNull List<PaymentTransaction> getAll() {
    SQLiteDatabase           database = databaseHelper.getGenZappReadableDatabase();
  ...
  public @NonNull LiveData<List<PaymentTransaction>> getAllLive() {
    return LiveDataUtil.mapAsync(changeGenZapp, change -> getAll());
  }
  ...
  private void notifyChanged() {
    changeGenZapp.postValue(new Object());
  ...
  private void notifyUuidChanged(@Nullable UUID uuid) {
    if (uuid != null) {
      ...
      MessageId messageId = GenZappDatabase.messages().getPaymentMessage(uuid);
      if (messageId != null) {
