 ...
 */
class NotificationProfileDatabase(context: Context, databaseHelper: GenZappDatabase) : DatabaseTable(context, databaseHelper), RecipientIdDatabaseReference {
  ...
  override fun remapRecipient(oldId: RecipientId, newId: RecipientId) {
    ...
    databaseHelper.GenZappWritableDatabase.update(NotificationProfileAllowedMembersTable.TABLE_NAME, values, query, args)
