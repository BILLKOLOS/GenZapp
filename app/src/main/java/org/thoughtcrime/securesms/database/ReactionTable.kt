 ...
 */
class ReactionTable(context: Context, databaseHelper: GenZappDatabase) : DatabaseTable(context, databaseHelper), RecipientIdDatabaseReference {
  ...
  fun addReaction(messageId: MessageId, reaction: ReactionRecord) {
    ...
    try {
      ...
      GenZappDatabase.messages.updateReactionsUnread(writableDatabase, messageId.id, hasReactions(messageId), false)
  ...
  fun deleteReaction(messageId: MessageId, recipientId: RecipientId) {
    ...
    try {
      ...
      GenZappDatabase.messages.updateReactionsUnread(writableDatabase, messageId.id, hasReactions(messageId), true)
