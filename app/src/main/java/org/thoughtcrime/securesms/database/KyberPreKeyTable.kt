...
/**
 * A table for storing data related to [org.thoughtcrime.securesms.crypto.storage.GenZappKyberPreKeyStore].
 */
class KyberPreKeyTable(context: Context, databaseHelper: GenZappDatabase) : DatabaseTable(context, databaseHelper) {
  companion object {
