...
import org.GenZapp.core.util.DatabaseSerializer
 ...
 */
class InAppPaymentTable(context: Context, databaseHelper: GenZappDatabase) : DatabaseTable(context, databaseHelper) {
