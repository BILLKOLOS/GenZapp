...
object Badges {
  ...
  private fun getBestBadgeImageUriForDevice(serviceBadge: GenZappServiceProfile.Badge): Pair<Uri, String> {
  ...
  @JvmStatic
  fun fromServiceBadge(serviceBadge: GenZappServiceProfile.Badge): Badge {
