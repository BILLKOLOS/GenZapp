...
import org.whispersystems.GenZappservice.internal.websocket.DefaultErrorMapper
import org.whispersystems.GenZappservice.internal.websocket.DefaultResponseMapper
...
object S3 {
  ...
  private val okHttpClient by lazy { AppDependencies.GenZappOkHttpClient }
  ...
  fun s3Url(path: String): URL {
    try {
      return URI("https", "updates2.GenZapp.org", path, null).toURL()
