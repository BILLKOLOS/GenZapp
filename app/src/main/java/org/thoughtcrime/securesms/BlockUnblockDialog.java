...
public final class BlockUnblockDialog {
                                                   ...
                                                   @Nullable Runnable onBlockAndReportSpam)
  {
    ...
    if (recipient.isGroup()) {
      if (GenZappDatabase.groups().isActive(recipient.requireGroupId())) {
      ...
      builder.setTitle(resources.getString(R.string.BlockUnblockDialog_block_s, recipient.getDisplayName(context)));
      builder.setMessage(R.string.BlockUnblockDialog_block_getting_GenZapp_updates_and_news);
                                                     ...
                                                     @NonNull Runnable onUnblock)
  {
    ...
    if (recipient.isGroup()) {
      ...
      builder.setTitle(resources.getString(R.string.BlockUnblockDialog_unblock_s, recipient.getDisplayName(context)));
      builder.setMessage(R.string.BlockUnblockDialog_resume_getting_GenZapp_updates_and_news);
                                                        ...
                                                        @Nullable Runnable onBlockAndReportSpam)
  {
    ...
    if (recipient.isGroup()) {
      Recipient adder = GenZappDatabase.groups().getGroupInviter(recipient.requireGroupId());
      if (adder != null) {
