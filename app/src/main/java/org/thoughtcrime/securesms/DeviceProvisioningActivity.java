...
public class DeviceProvisioningActivity extends PassphraseRequiredActivity {
  ...
  protected void onCreate(Bundle bundle, boolean ready) {
    AlertDialog dialog = new MaterialAlertDialogBuilder(this)
        .setTitle(getString(R.string.DeviceProvisioningActivity_link_a_GenZapp_device))
        .setMessage(getString(R.string.DeviceProvisioningActivity_it_looks_like_youre_trying_to_link_a_GenZapp_device_using_a_3rd_party_scanner))
