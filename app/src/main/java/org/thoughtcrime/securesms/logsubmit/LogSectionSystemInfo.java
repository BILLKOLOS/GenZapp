...
public class LogSectionSystemInfo implements LogSection {
  ...
  public @NonNull CharSequence getContent(@NonNull Context context) {
    ...
    builder.append("RecipientId       : ").append(GenZappStore.registration().isRegistrationComplete() ? Recipient.self().getId() : "N/A").append("\n");
    builder.append("ACI               : ").append(getCensoredAci(context)).append("\n");
    builder.append("Device ID         : ").append(GenZappStore.account().getDeviceId()).append("\n");
    builder.append("Censored          : ").append(AppDependencies.getGenZappServiceNetworkAccess().isCensored()).append("\n");
    builder.append("Network Status    : ").append(NetworkUtil.getNetworkStatus(context)).append("\n");
    builder.append("Play Services     : ").append(getPlayServicesString(context)).append("\n");
    builder.append("FCM               : ").append(GenZappStore.account().isFcmEnabled()).append("\n");
    ...
    builder.append("Server Time Offset: ").append(GenZappStore.misc().getLastKnownServerTimeOffset()).append(" ms (last updated: ").append(GenZappStore.misc().getLastKnownServerTimeOffsetUpdateTime()).append(")").append("\n");
  ...
  private static String getCensoredAci(@NonNull Context context) {
    ACI aci = GenZappStore.account().getAci();
