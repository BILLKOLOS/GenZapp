...
final class LogSectionNotifications implements LogSection {
  ...
  public @NonNull CharSequence getContent(@NonNull Context context) {
    ...
    output.append("Message notifications: ").append(GenZappStore.settings().isMessageNotificationsEnabled()).append("\n")
          .append("Call notifications   : ").append(GenZappStore.settings().isCallNotificationsEnabled()).append("\n")
          .append("New contact alerts   : ").append(GenZappStore.settings().isNotifyWhenContactJoinsGenZapp()).append("\n")
          .append("In-chat sounds       : ").append(GenZappStore.settings().isMessageNotificationsInChatSoundsEnabled()).append("\n")
          .append("Repeat alerts        : ").append(GenZappStore.settings().getMessageNotificationsRepeatAlerts()).append("\n")
          .append("Notification display : ").append(GenZappStore.settings().getMessageNotificationsPrivacy()).append("\n\n");
