...
class MediaSelectionActivity :
  ...
  private fun animateTextStyling(selectedSwitch: TextView, unselectedSwitch: TextView, duration: Long) {
    val offTextColor = ContextCompat.getColor(this, R.color.GenZapp_colorOnSurface)
    val onTextColor = ContextCompat.getColor(this, R.color.GenZapp_colorSecondaryContainer)
  ...
  companion object {
    ...
    private fun buildIntent(
      context: Context,
      startAction: Int = -1,
      messageSendType: MessageSendType = MessageSendType.GenZappMessageSendType,
