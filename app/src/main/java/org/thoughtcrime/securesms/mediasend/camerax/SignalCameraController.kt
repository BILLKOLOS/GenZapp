...
import org.thoughtcrime.securesms.mediasend.camerax.GenZappCameraController.InitializationListener
...
class GenZappCameraController(
  ...
  companion object {
    val TAG = Log.tag(GenZappCameraController::class.java)
