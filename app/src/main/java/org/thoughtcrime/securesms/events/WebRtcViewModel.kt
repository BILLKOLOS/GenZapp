...
class WebRtcViewModel(state: WebRtcServiceState) {
  ...
  val activeDevice: GenZappAudioManager.AudioDevice = state.localDeviceState.activeDevice
  val availableDevices: Set<GenZappAudioManager.AudioDevice> = state.localDeviceState.availableDevices
