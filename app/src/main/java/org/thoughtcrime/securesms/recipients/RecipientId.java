...
public class RecipientId implements Parcelable, Comparable<RecipientId>, DatabaseId {
  ...
  @AnyThread
  public static @NonNull RecipientId from(@NonNull GenZappServiceAddress address) {
  ...
  public static @NonNull RecipientId from(@NonNull GroupId groupId) {
    ...
    if (recipientId == null) {
      ...
      recipientId = GenZappDatabase.recipients().getOrInsertFromPossiblyMigratedGroupId(groupId);
      if (groupId.isV2()) {
  ...
  private static @NonNull RecipientId from(@Nullable ServiceId serviceId, @Nullable String e164) {
    ...
    if (recipientId == null) {
      recipientId = GenZappDatabase.recipients().getAndPossiblyMerge(serviceId, e164);
