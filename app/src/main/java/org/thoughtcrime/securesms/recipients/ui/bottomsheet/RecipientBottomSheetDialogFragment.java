...
import org.thoughtcrime.securesms.fonts.GenZappSymbols;
...
public final class RecipientBottomSheetDialogFragment extends BottomSheetDialogFragment {
  ...
  public void onCreate(@Nullable Bundle savedInstanceState) {
    setStyle(DialogFragment.STYLE_NORMAL,
             ThemeUtil.isDarkTheme(requireContext()) ? R.style.Theme_GenZapp_RoundedBottomSheet
                                                     : R.style.Theme_GenZapp_RoundedBottomSheet_Light);
  ...
  public void onViewCreated(@NonNull View fragmentView, @Nullable Bundle savedInstanceState) {
    ...
    viewModel.getRecipient().observe(getViewLifecycleOwner(), recipient -> {
      ...
      if (recipient.getShowVerified()) {
        ...
        CharSequence systemContactGlyph = GenZappSymbols.getSpannedString(requireContext(),
                                                                         GenZappSymbols.Weight.BOLD,
                                                                         GenZappSymbols.Glyph.PERSON_CIRCLE);
      ...
      if (!recipient.isSelf() && recipient.isIndividual()) {
        CharSequence chevronGlyph = GenZappSymbols.getSpannedString(requireContext(),
                                                                   GenZappSymbols.Weight.BOLD,
                                                                   GenZappSymbols.Glyph.CHEVRON_RIGHT);

        nameBuilder.append(" ");
        nameBuilder.append(SpanUtil.color(ContextCompat.getColor(requireContext(), R.color.GenZapp_colorOutline),
      ...
      if (recipient.isReleaseNotes()) {
        aboutText = getString(R.string.ReleaseNotes__GenZapp_release_notes_and_news);
      }
