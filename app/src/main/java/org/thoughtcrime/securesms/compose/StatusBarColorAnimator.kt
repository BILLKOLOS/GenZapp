...
class StatusBarColorAnimator(
  ...
  private val normalColor = ContextCompat.getColor(activity, R.color.GenZapp_colorBackground)
  private val scrollColor = ContextCompat.getColor(activity, R.color.GenZapp_colorSurface2)
