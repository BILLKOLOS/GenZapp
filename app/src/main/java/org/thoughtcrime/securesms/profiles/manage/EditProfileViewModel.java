...
class EditProfileViewModel extends ViewModel {
  ...
  public boolean isRegisteredAndUpToDate() {
    return !TextSecurePreferences.isUnauthorizedReceived(AppDependencies.getApplication()) && GenZappStore.account().isRegistered() && !GenZappStore.misc().isClientDeprecated();
  }
  ...
  private void onRecipientChanged(@NonNull Recipient recipient) {
    ...
    username.postValue(GenZappStore.account().getUsername());
