...
class EditProfileFragment : LoggingFragment() {
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    binding.manageProfileUsernameContainer.setOnClickListener { v: View ->
      if (!viewModel.isRegisteredAndUpToDate) {
        onClickWhenUnregisteredOrDeprecated()
      } else if (GenZappStore.account.username != null) {
        MaterialAlertDialogBuilder(requireContext(), R.style.ThemeOverlay_GenZapp_MaterialAlertDialog_List)
  ...
  private fun presentUsername(username: String?) {
    ...
    if (GenZappStore.account.usernameSyncState == AccountValues.UsernameSyncState.USERNAME_AND_LINK_CORRUPTED) {
      binding.usernameErrorIndicator.visibility = View.VISIBLE
    } else {
      binding.usernameErrorIndicator.visibility = View.GONE
    }

    if (GenZappStore.account.username != null && GenZappStore.account.usernameSyncState != AccountValues.UsernameSyncState.USERNAME_AND_LINK_CORRUPTED) {
      ...
      if (GenZappStore.tooltips.showProfileSettingsQrCodeTooltop()) {
        ...
        binding.linkTooltipCloseButton.setOnClickListener {
          ...
          GenZappStore.tooltips.markProfileSettingsQrCodeTooltipSeen()
        }
      }
  ...
  private fun displayConfirmUsernameDeletionDialog() {
    MaterialAlertDialogBuilder(requireContext())
      ...
      .setMessage(requireContext().getString(R.string.ManageProfileFragment__delete_username_dialog_body, GenZappStore.account.username))
