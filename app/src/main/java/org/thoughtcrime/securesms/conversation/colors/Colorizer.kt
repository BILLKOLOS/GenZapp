...
class Colorizer {
  ...
  fun getIncomingBodyTextColor(context: Context, hasWallpaper: Boolean): Int {
    return if (hasWallpaper) {
      ContextCompat.getColor(context, R.color.GenZapp_colorNeutralInverse)
    } else {
      ContextCompat.getColor(context, R.color.GenZapp_colorOnSurface)
    }
  }
  ...
  fun getIncomingFooterTextColor(context: Context, hasWallpaper: Boolean): Int {
    return if (hasWallpaper) {
      ContextCompat.getColor(context, R.color.GenZapp_colorNeutralVariantInverse)
    } else {
      ContextCompat.getColor(context, R.color.GenZapp_colorOnSurfaceVariant)
    }
  }
