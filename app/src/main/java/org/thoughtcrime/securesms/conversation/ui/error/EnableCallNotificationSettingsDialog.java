...
public final class EnableCallNotificationSettingsDialog extends DialogFragment {
  ...
  public static void fixAutomatically(@NonNull Context context) {
    if (areCallNotificationsDisabled(context)) {
      GenZappStore.settings().setCallNotificationsEnabled(true);
  ...
  public Dialog onCreateDialog(Bundle savedInstanceState) {
    MaterialAlertDialogBuilder dialogBuilder = new MaterialAlertDialogBuilder(requireContext(), R.style.ThemeOverlay_GenZapp_MaterialAlertDialog);
  ...
  private static boolean areCallNotificationsDisabled(Context context) {
    return !GenZappStore.settings().isCallNotificationsEnabled();
  }
