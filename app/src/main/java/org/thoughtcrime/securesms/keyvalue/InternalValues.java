...
public final class InternalValues extends GenZappStoreValues {
   ...
   * the default SFU will be returned. This ensures that if the {@link BuildConfig#GenZapp_SFU_INTERNAL_URLS} list changes,
  ...
  public synchronized @NonNull String groupCallingServer() {
    ...
    if (internalServer != null && !Arrays.asList(BuildConfig.GenZapp_SFU_INTERNAL_URLS).contains(internalServer)) {
      internalServer = null;
    }
    return internalServer != null ? internalServer : BuildConfig.GenZapp_SFU_URL;
  }
