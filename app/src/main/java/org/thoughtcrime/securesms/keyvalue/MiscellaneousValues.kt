...
class MiscellaneousValues internal constructor(store: KeyValueStore) : GenZappStoreValues(store) {
  companion object {
   ...
   *
   * estimatedServerTime = System.currentTimeMillis() - GenZappStore.misc.getLastKnownServerTimeOffset()
   */
