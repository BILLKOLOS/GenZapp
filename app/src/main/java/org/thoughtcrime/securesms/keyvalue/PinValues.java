 ...
 */
public final class PinValues extends GenZappStoreValues {
  ...
  public void onEntrySuccess(@NonNull String pin) {
    long nextInterval = GenZappPinReminders.getNextInterval(getCurrentInterval());
    ...
    GenZappStore.svr().setPinIfNotPresent(pin);
  }

  public void onEntrySuccessWithWrongGuess(@NonNull String pin) {
    long nextInterval = GenZappPinReminders.getPreviousInterval(getCurrentInterval());
  ...
  public void resetPinReminders() {
    long nextInterval = GenZappPinReminders.INITIAL_INTERVAL;
  ...
  public @NonNull PinKeyboardType getKeyboardType() {
    String pin = GenZappStore.svr().getPin();
