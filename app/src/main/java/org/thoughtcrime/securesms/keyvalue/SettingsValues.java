...
public final class SettingsValues extends GenZappStoreValues {
  ...
  private static final String GenZapp_BACKUP_DIRECTORY        = "settings.GenZapp.backup.directory";
  private static final String GenZapp_LATEST_BACKUP_DIRECTORY = "settings.GenZapp.backup.directory,latest";
  private static final String CALL_DATA_MODE                 = "settings.GenZapp.call.bandwidth.mode";
  ...
  public static final  String NOTIFY_WHEN_CONTACT_JOINS_GenZapp        = "settings.notify.when.contact.joins.GenZapp";
  ...
  @NonNull List<String> getKeysToIncludeInBackup() {
    return Arrays.asList(LINK_PREVIEWS,
                         ...
                         NOTIFY_WHEN_CONTACT_JOINS_GenZapp,
  ...
  public void setGenZappBackupDirectory(@NonNull Uri uri) {
    putString(GenZapp_BACKUP_DIRECTORY, uri.toString());
    putString(GenZapp_LATEST_BACKUP_DIRECTORY, uri.toString());
  }
  ...
  public @Nullable Uri getGenZappBackupDirectory() {
    return getUri(GenZapp_BACKUP_DIRECTORY);
  }

  public @Nullable Uri getLatestGenZappBackupDirectory() {
    return getUri(GenZapp_LATEST_BACKUP_DIRECTORY);
  }

  public void clearGenZappBackupDirectory() {
    putString(GenZapp_BACKUP_DIRECTORY, null);
  }
  ...
  public boolean isNotifyWhenContactJoinsGenZapp() {
    return getBoolean(NOTIFY_WHEN_CONTACT_JOINS_GenZapp, TextSecurePreferences.isNewContactsNotificationEnabled(AppDependencies.getApplication()));
  }

  public void setNotifyWhenContactJoinsGenZapp(boolean notifyWhenContactJoinsGenZapp) {
    putBoolean(NOTIFY_WHEN_CONTACT_JOINS_GenZapp, notifyWhenContactJoinsGenZapp);
  }
