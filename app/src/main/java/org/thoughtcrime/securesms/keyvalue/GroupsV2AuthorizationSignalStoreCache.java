...
import org.GenZapp.libGenZapp.zkgroup.auth.AuthCredentialWithPniResponse;
import org.GenZapp.libGenZapp.zkgroup.calllinks.CallLinkAuthCredentialResponse;
import org.GenZapp.libGenZapp.zkgroup.internal.ByteArray;
...
public final class GroupsV2AuthorizationGenZappStoreCache implements GroupsV2Authorization.ValueCache {

  private static final String TAG = Log.tag(GroupsV2AuthorizationGenZappStoreCache.class);
  ...
  public static GroupsV2AuthorizationGenZappStoreCache createAciCache(@NonNull KeyValueStore store) {
    ...
    return new GroupsV2AuthorizationGenZappStoreCache(store, ACI_PNI_PREFIX + ":" + ACI_PNI_VERSION);
  }

  private GroupsV2AuthorizationGenZappStoreCache(@NonNull KeyValueStore store, @NonNull String key) {
    this.store           = store;
    this.key             = key;
