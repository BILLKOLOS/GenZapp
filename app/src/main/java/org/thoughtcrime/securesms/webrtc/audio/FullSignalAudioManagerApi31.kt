 ...
 * and the previous GenZappAudioManager implementation would have required us to ask for (poorly labeled & scary) Bluetooth permissions.
 */
@RequiresApi(31)
class FullGenZappAudioManagerApi31(context: Context, eventListener: EventListener?) : GenZappAudioManager(context, eventListener) {
  private val TAG = "GenZappAudioManager31"
