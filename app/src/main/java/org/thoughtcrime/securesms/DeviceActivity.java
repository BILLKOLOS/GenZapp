    ...
    implements Button.OnClickListener, ScanListener, DeviceLinkFragment.LinkClickedListener
{
  ...
  public void onClick(View v) {
    Permissions.with(this)
               ...
               .withPermanentDenialDialog(getString(R.string.DeviceActivity_GenZapp_needs_the_camera_permission_in_order_to_scan_a_qr_code), null, R.string.CameraXFragment_allow_access_camera, R.string.CameraXFragment_to_scan_qr_codes, getSupportFragmentManager())
               .onAllGranted(() -> {
               ...
               .onAnyDenied(() -> Toast.makeText(this, R.string.CameraXFragment_GenZapp_needs_camera_access_scan_qr_code, Toast.LENGTH_LONG).show())
               .execute();
  }
                                                     ...
                                                     R.string.DeviceProvisioningActivity_content_progress_content)
    {
      ...
      protected Integer doInBackground(Void... params) {
        ...
        try {
          ...
          IdentityKeyPair aciIdentityKeyPair = GenZappStore.account().getAciIdentityKey();
          IdentityKeyPair pniIdentityKeyPair = GenZappStore.account().getPniIdentityKey();
