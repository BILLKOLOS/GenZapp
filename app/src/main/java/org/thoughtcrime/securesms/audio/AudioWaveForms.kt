...
object AudioWaveForms {
  ...
  private fun generateWaveForm(context: Context, uri: Uri, cacheKey: String, attachmentId: AttachmentId): CacheCheckResult {
    try {
      ...
      GenZappDatabase.attachments.writeAudioHash(attachmentId, AudioWaveFormData())
      ...
      GenZappDatabase.attachments.writeAudioHash(attachmentId, fileInfo.toDatabaseProtobuf())
