...
public class AudioRecorder {
  ...
  private static final ExecutorService executor = GenZappExecutors.newCachedSingleThreadExecutor("GenZapp-AudioRecorder", ThreadUtil.PRIORITY_UI_BLOCKING_THREAD);
