...
import org.GenZapp.devicetransfer.ClientTask;
 ...
 * Used in conjunction with {@link org.GenZapp.devicetransfer.DeviceToDeviceTransferService}.
 */
final class OldDeviceClientTask implements ClientTask {
  ...
  @Override
  public void success() {
    GenZappStore.misc().setOldDeviceTransferLocked(true);
