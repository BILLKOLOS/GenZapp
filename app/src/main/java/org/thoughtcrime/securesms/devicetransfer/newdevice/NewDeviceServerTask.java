...
import org.GenZapp.devicetransfer.ServerTask;
 ...
 * conjunction with {@link org.GenZapp.devicetransfer.DeviceToDeviceTransferService}.
 */
final class NewDeviceServerTask implements ServerTask {
  ...
  public void run(@NonNull Context context, @NonNull InputStream inputStream) {
    ...
    try {
      ...
      SQLiteDatabase database = GenZappDatabase.getBackupDatabase();
