...
public class InviteActivity extends PassphraseRequiredActivity implements ContactSelectionListFragment.OnContactSelectedListener {
  ...
  private void initializeResources() {
    ...
    inviteText.setText(getString(R.string.InviteActivity_lets_switch_to_GenZapp, getString(R.string.install_url)));
  ...
  private class ShareClickListener implements OnClickListener {
    ...
    public void onClick(View v) {
      ...
      if (sendIntent.resolveActivity(getPackageManager()) != null) {
        startActivity(Intent.createChooser(sendIntent, getString(R.string.InviteActivity_invite_to_GenZapp)));
      } else {
