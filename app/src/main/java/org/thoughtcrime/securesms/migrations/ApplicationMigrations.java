...
//    static final int DECRYPTIONS_DRAINED           = 80;
    ...
    static final int COPY_USERNAME_TO_GenZapp_STORE = 95;
 ...
 /**
  ...
  public static void onApplicationCreate(@NonNull Context context, @NonNull JobManager jobManager) {
    ...
    if (!isUpdate(context)) {
      ...
      GenZappStore.misc().setClientDeprecated(false);
    }
...
//    }
    ...
    if (lastSeenVersion < Version.COPY_USERNAME_TO_GenZapp_STORE) {
      jobs.put(Version.COPY_USERNAME_TO_GenZapp_STORE, new CopyUsernameToGenZappStoreMigrationJob());
    }
