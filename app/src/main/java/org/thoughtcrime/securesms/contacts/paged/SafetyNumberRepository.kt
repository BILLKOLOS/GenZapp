...
import org.whispersystems.GenZappservice.internal.push.IdentityCheckResponse
...
class SafetyNumberRepository(
  ...
  private val aciIdentityStore: GenZappIdentityKeyStore = AppDependencies.protocolStore.aci().identities()
) {
