...
/**
 * Activity which displays a dialog to confirm whether to turn off "Contact Joined GenZapp" notifications.
 */
public class TurnOffContactJoinedNotificationsActivity extends AppCompatActivity {
  ...
  protected void onResume() {
    ...
    new MaterialAlertDialogBuilder(this)
        .setMessage(R.string.TurnOffContactJoinedNotificationsActivity__turn_off_contact_joined_GenZapp)
  ...
  private void handlePositiveAction(@NonNull DialogInterface dialog) {
    SimpleTask.run(getLifecycle(), () -> {
      ...
      GenZappStore.settings().setNotifyWhenContactJoinsGenZapp(false);
