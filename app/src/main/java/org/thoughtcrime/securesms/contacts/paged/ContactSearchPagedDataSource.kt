...
class ContactSearchPagedDataSource(
  ...
  override fun load(start: Int, length: Int, totalSize: Int, cancellationGenZapp: PagedDataSource.CancellationGenZapp): MutableList<ContactSearchData> {
  ...
  private fun getNonGroupSearchIterator(section: ContactSearchConfiguration.Section.Individuals, query: String?): ContactSearchIterator<Cursor> {
    ...
    return CursorSearchIterator(wrapRecipientCursor(contactSearchPagedDataSourceRepository.queryGenZappContacts(searchQuery)))
  }
  ...
  private fun getNonGroupHeaderLetterMap(section: ContactSearchConfiguration.Section.Individuals, query: String?): Map<RecipientId, String> {
    return contactSearchPagedDataSourceRepository.queryGenZappContactLetterHeaders(
      query = query,
