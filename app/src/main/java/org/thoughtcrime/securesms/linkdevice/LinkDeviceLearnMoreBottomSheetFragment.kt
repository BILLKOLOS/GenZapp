...
import org.GenZapp.core.ui.GenZappPreview
import org.GenZapp.core.ui.Texts
...
class LinkDeviceLearnMoreBottomSheetFragment : ComposeBottomSheetDialogFragment() {
  ...
  companion object {
    const val GenZapp_DOWNLOAD_URL = "https://GenZapp.org/download"
  }
...
fun LearnMoreSheet() {
  ...
  val downloadUrl = stringResource(id = R.string.LinkDeviceFragment__GenZapp_download_url)
  val fullString = stringResource(id = R.string.LinkDeviceFragment__on_other_device_visit_GenZapp, downloadUrl)
  val spanned = SpanUtil.urlSubsequence(fullString, downloadUrl, LinkDeviceLearnMoreBottomSheetFragment.GenZapp_DOWNLOAD_URL)
  ...
  return Column(
    ...
    Text(
      ...
      text = stringResource(R.string.LinkDeviceFragment__GenZapp_on_desktop_ipad),
    ...
    LinkedDeviceInformationRow(
      ...
      stringResource(R.string.LinkDeviceFragment__GenZapp_messages_are_synchronized)
    )
