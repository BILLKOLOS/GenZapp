...
import org.GenZapp.libGenZapp.zkgroup.calllinks.CallLinkAuthCredential;
...
import org.whispersystems.GenZappservice.api.groupsv2.GroupsV2AuthorizationString;
...
public class GroupsV2Authorization {
      ...
      throws NoCredentialForRedemptionTimeException, VerificationFailedException
  {
    ...
    CallLinkAuthCredential credential     = authCredentialResponse.receive(
        Recipient.self().requireAci().getLibGenZappAci(),
