...
public final class GroupLimitDialog {
  ...
  public static void showHardLimitMessage(@NonNull Context context) {
    new MaterialAlertDialogBuilder(context)
                   ...
                   .setMessage(context.getString(R.string.ContactSelectionListFragment_GenZapp_groups_can_have_a_maximum_of_d_members, RemoteConfig.groupLimits().getHardLimit()))
  ...
  public static void showRecommendedLimitMessage(@NonNull Context context) {
    new MaterialAlertDialogBuilder(context)
                   ...
                   .setMessage(context.getString(R.string.ContactSelectionListFragment_GenZapp_groups_perform_best_with_d_members_or_fewer, RemoteConfig.groupLimits().getRecommendedLimit()))
                   .setPositiveButton(android.R.string.ok, null)
                   .show();
  }
}
