...
import org.GenZapp.core.util.DatabaseId;
import org.GenZapp.core.util.Hex;
import org.GenZapp.libGenZapp.protocol.kdf.HKDFv3;
...
public abstract class GroupId implements DatabaseId {
  ...
  private static final String ENCODED_GenZapp_GROUP_V1_PREFIX = "__textsecure_group__!";
  private static final String ENCODED_GenZapp_GROUP_V2_PREFIX = "__GenZapp_group__v2__!";
  private static final String ENCODED_MMS_GROUP_PREFIX       = "__GenZapp_mms_group__!";
  ...
  public static @NonNull GroupId parse(@NonNull String encodedGroupId) throws BadGroupIdException {
    try {
      ...
      if      (encodedGroupId.startsWith(ENCODED_GenZapp_GROUP_V2_PREFIX)) return v2(bytes);
      else if (encodedGroupId.startsWith(ENCODED_GenZapp_GROUP_V1_PREFIX)) return v1(bytes);
  ...
  public static boolean isEncodedGroup(@NonNull String groupId) {
    return groupId.startsWith(ENCODED_GenZapp_GROUP_V2_PREFIX) ||
           groupId.startsWith(ENCODED_GenZapp_GROUP_V1_PREFIX) ||
  ...
  public static final class V1 extends GroupId.Push {
    ...
    private V1(@NonNull byte[] bytes) {
      super(ENCODED_GenZapp_GROUP_V1_PREFIX, bytes);
    }
  ...
  public static final class V2 extends GroupId.Push {
    ...
    private V2(@NonNull byte[] bytes) {
      super(ENCODED_GenZapp_GROUP_V2_PREFIX, bytes);
    }
