...
import org.whispersystems.GenZappservice.api.crypto.AttachmentCipherInputStream;
  ...
  public long open(DataSpec dataSpec) throws IOException {
    ...
    if (inProgress && !hasData && hasIncrementalDigest && attachmentKey != null) {
      ...
      if (attachment.transferState == AttachmentTable.TRANSFER_RESTORE_IN_PROGRESS && attachment.archiveMediaId != null) {
        ...
        try {
          BackupKey.MediaKeyMaterial mediaKeyMaterial = GenZappStore.svr().getOrCreateMasterKey().deriveBackupKey().deriveMediaSecretsFromMediaId(attachment.archiveMediaId);
