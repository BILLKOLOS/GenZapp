...
/**
 * This class is responsible for creating a MediaSource object for a given Uri, using {@link GenZappDataSource.Factory}.
 */
@OptIn(markerClass = UnstableApi.class)
public final class GenZappMediaSourceFactory implements MediaSource.Factory {

  private final ProgressiveMediaSource.Factory progressiveMediaSourceFactory;

  public GenZappMediaSourceFactory(@NonNull Context context) {
    DataSource.Factory attachmentDataSourceFactory = new GenZappDataSource.Factory(context, null, ExoPlayerPool.DataSourceTransferListener.INSTANCE);
