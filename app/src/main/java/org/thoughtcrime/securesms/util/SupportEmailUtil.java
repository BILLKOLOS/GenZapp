...
import org.GenZapp.core.util.ResourceUtil;
...
public final class SupportEmailUtil {
  ...
  private static @NonNull String buildSystemInfo(@NonNull Context context, @StringRes int filter, @NonNull String filterSuffix) {
    ...
    return "--- " + context.getString(R.string.HelpFragment__support_info) + " ---" +
           ...
           "\n" +
           context.getString(R.string.SupportEmailUtil_GenZapp_version) + " " + getGenZappVersion() +
           "\n" +
           context.getString(R.string.SupportEmailUtil_GenZapp_package) + " " + getGenZappPackage(context) +
           "\n" +
  ...
  private static CharSequence getGenZappVersion() {
    return BuildConfig.VERSION_NAME;
  }

  private static CharSequence getGenZappPackage(@NonNull Context context) {
  ...
  private static CharSequence getRegistrationLockEnabled() {
    return String.valueOf(GenZappStore.svr().isRegistrationLockEnabled());
  }
}
