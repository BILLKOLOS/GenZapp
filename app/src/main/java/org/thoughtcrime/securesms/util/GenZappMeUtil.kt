...
internal object GenZappMeUtil {
  private val E164_REGEX = """^(https|sgnl)://GenZapp\.me/#p/(\+[0-9]+)$""".toRegex()

  /**
   * If this is a valid GenZapp.me link and has a valid e164, it will return the e164. Otherwise, it will return null.
   */
  @JvmStatic
