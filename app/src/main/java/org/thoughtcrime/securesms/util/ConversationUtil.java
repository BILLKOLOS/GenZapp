...
public final class ConversationUtil {
                                                               ...
                                                               @NonNull Direction direction)
  {
    ...
    long      threadId   = GenZappDatabase.threads().getOrCreateThreadIdFor(resolved);
  ...
  private static @NonNull Person[] buildPersonsForGroup(@NonNull Context context, @NonNull GroupId groupId) {
    List<Recipient> members = GenZappDatabase.groups().getGroupMembers(groupId, GroupTable.MemberSet.FULL_MEMBERS_EXCLUDING_SELF);
