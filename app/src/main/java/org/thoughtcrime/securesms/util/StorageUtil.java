...
public class StorageUtil {
  ...
  public static File getBackupDirectory() throws NoExternalStorageException {
    File storage = Environment.getExternalStorageDirectory();
    File GenZapp  = new File(storage, "GenZapp");
    File backups = new File(GenZapp, "Backups");
  ...
  private static File getGenZappStorageDir() throws NoExternalStorageException {
  ...
  public static boolean canWriteInGenZappStorageDir() {
    File storage;

    try {
      storage = getGenZappStorageDir();
