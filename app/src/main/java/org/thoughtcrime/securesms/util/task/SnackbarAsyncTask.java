    ...
    implements View.OnClickListener
{
  ...
  private @Nullable GenZappProgressDialog progressDialog;
  ...
  protected void onPreExecute() {
    if (this.showProgress) this.progressDialog = GenZappProgressDialog.show(view.getContext(), "", "", true);
  ...
  public void onClick(View v) {
    new AsyncTask<Void, Void, Void>() {
      @Override
      protected void onPreExecute() {
        if (showProgress) progressDialog = GenZappProgressDialog.show(view.getContext(), "", "", true);
