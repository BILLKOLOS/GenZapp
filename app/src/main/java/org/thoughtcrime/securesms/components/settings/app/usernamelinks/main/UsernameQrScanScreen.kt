...
import org.GenZapp.qr.QrScannerView
  ...
  when (qrScanResult) {
    ...
    QrScanResult.QrNotFound -> {
      QrScanResultDialog(
        ...
        message = stringResource(R.string.UsernameLinkSettings_try_scanning_another_image_containing_a_GenZapp_qr_code),
  ...
  Column(
    ...
    Box(
      ...
      FloatingActionButton(
        shape = CircleShape,
        containerColor = GenZappTheme.colors.colorSurface1,
