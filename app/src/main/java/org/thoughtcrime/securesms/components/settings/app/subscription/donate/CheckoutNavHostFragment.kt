    ...
    if (savedInstanceState == null) {
      ...
      navGraph.setStartDestination(
        when (inAppPaymentType) {
          ...
          InAppPaymentType.ONE_TIME_DONATION, InAppPaymentType.RECURRING_DONATION -> R.id.donateToGenZappFragment
      ...
      val startBundle = when (inAppPaymentType) {
        ...
        InAppPaymentType.ONE_TIME_DONATION, InAppPaymentType.RECURRING_DONATION -> DonateToGenZappFragmentArgs.Builder(inAppPaymentType).build().toBundle()
      }
