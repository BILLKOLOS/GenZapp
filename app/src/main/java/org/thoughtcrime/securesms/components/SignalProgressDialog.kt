 ...
 */
class GenZappProgressDialog private constructor(
  ...
  companion object {
    ...
    fun show(
      ...
      val customView = LayoutInflater.from(context).inflate(R.layout.GenZapp_progress_dialog, null) as ConstraintLayout
      ...
      return GenZappProgressDialog(dialog, titleView, messageView, progressView)
    }
  }
}
