...
class TransferProgressView @JvmOverloads constructor(
  ...
  init {
    ...
    val GenZappCustomColor = ContextCompat.getColor(context, R.color.GenZapp_colorOnCustom)
    val GenZappTransparent2 = ContextCompat.getColor(context, R.color.GenZapp_colorTransparent2)

    iconColor = typedArray.getColor(R.styleable.TransferProgressView_transferIconColor, GenZappCustomColor)
    progressColor = typedArray.getColor(R.styleable.TransferProgressView_progressColor, GenZappCustomColor)
    trackColor = typedArray.getColor(R.styleable.TransferProgressView_trackColor, GenZappTransparent2)
