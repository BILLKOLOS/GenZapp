...
public final class WebRtcControls {
  ...
  public static final WebRtcControls PIP  = new WebRtcControls(false,
                                                               ...
                                                               null,
                                                               FoldableState.flat(),
                                                               GenZappAudioManager.AudioDevice.NONE,
                                                               emptySet(),
                                                               false,
                                                               false);
  ...
  private final GenZappAudioManager.AudioDevice      activeDevice;
  private final Set<GenZappAudioManager.AudioDevice> availableDevices;
  ...
  WebRtcControls(boolean isLocalVideoEnabled,
                 ...
                 @NonNull GenZappAudioManager.AudioDevice activeDevice,
                 @NonNull Set<GenZappAudioManager.AudioDevice> availableDevices,
                 boolean isCallLink,
  ...
  public boolean isBluetoothHeadsetAvailableForAudioToggle() {
    return availableDevices.contains(GenZappAudioManager.AudioDevice.BLUETOOTH);
  }

  public boolean isWiredHeadsetAvailableForAudioToggle() {
    return availableDevices.contains(GenZappAudioManager.AudioDevice.WIRED_HEADSET);
  }
