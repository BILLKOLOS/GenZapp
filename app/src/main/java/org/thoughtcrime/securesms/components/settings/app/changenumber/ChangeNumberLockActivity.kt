...
class ChangeNumberLockActivity : PassphraseRequiredActivity() {
  ...
  private fun onChangeStatusConfirmed() {
    GenZappStore.misc.clearPendingChangeNumberMetadata()

    MaterialAlertDialogBuilder(this)
      .setTitle(R.string.ChangeNumberLockActivity__change_status_confirmed)
      .setMessage(getString(R.string.ChangeNumberLockActivity__your_number_has_been_confirmed_as_s, PhoneNumberFormatter.prettyPrint(GenZappStore.account.e164!!)))
