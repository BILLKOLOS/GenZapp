...
open class SimpleEmojiTextView @JvmOverloads constructor(
  ...
  init {
    isEmojiCompatEnabled = isInEditMode || GenZappStore.settings.isPreferSystemEmoji
  ...
  override fun setText(text: CharSequence?, type: BufferType?) {
    ...
    if (GenZappStore.settings.isPreferSystemEmoji || candidates == null || candidates.size() == 0) {
