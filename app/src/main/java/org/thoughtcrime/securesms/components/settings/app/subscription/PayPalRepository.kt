...
import org.whispersystems.GenZappservice.api.subscriptions.PayPalConfirmPaymentIntentResponse
import org.whispersystems.GenZappservice.api.subscriptions.PayPalCreatePaymentIntentResponse
import org.whispersystems.GenZappservice.api.subscriptions.PayPalCreatePaymentMethodResponse
...
class PayPalRepository(private val donationsService: DonationsService) {
  ...
  companion object {
    const val ONE_TIME_RETURN_URL = "https://GenZappdonations.org/return/onetime"
    const val MONTHLY_RETURN_URL = "https://GenZappdonations.org/return/monthly"
    const val CANCEL_URL = "https://GenZappdonations.org/cancel"
    ...
    return Single
      ...
      .flatMapCompletable { subscriberRecord ->
        Single.fromCallable {
          ...
          GenZappDatabase.inAppPaymentSubscribers.setPaymentMethod(
            subscriberRecord.subscriberId,
