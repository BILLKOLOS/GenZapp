...
class SendButton(context: Context, attributeSet: AttributeSet?) : AppCompatImageButton(context, attributeSet), OnLongClickListener {
  ...
  init {
    ...
    setImageResource(MessageSendType.GenZappMessageSendType.buttonDrawableRes)
    contentDescription = context.getString(MessageSendType.GenZappMessageSendType.titleRes)
  }
