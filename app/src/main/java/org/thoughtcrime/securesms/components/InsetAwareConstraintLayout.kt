...
open class InsetAwareConstraintLayout @JvmOverloads constructor(
  ...
  private fun getKeyboardHeight(): Int {
    val height = if (isLandscape()) {
      GenZappStore.misc.keyboardLandscapeHeight
    } else {
      GenZappStore.misc.keyboardPortraitHeight
    }
  ...
  private fun setKeyboardHeight(height: Int) {
    if (isLandscape()) {
      GenZappStore.misc.keyboardLandscapeHeight = height
    } else {
      GenZappStore.misc.keyboardPortraitHeight = height
    }
  }
