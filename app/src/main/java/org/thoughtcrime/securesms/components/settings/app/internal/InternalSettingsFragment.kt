...
import org.GenZapp.core.util.AppUtil
...
class InternalSettingsFragment : DSLSettingsFragment(R.string.preferences__internal_preferences) {
  ...
  override fun onPause() {
    ...
    if (firstVisiblePosition != null) {
      GenZappStore.internal.lastScrollPosition = firstVisiblePosition
    }
  }

  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    super.onViewCreated(view, savedInstanceState)
    scrollToPosition = GenZappStore.internal.lastScrollPosition
  }
  ...
  private fun getConfiguration(state: InternalSettingsState): DSLConfiguration {
    return configure {
        ...
        onClick = {
          MaterialAlertDialogBuilder(requireContext())
            ...
            .setPositiveButton(android.R.string.ok) { _, _ ->
              GenZappDatabase.signedPreKeys.debugDeleteAll()
              GenZappDatabase.oneTimePreKeys.debugDeleteAll()
              GenZappDatabase.kyberPreKeys.debugDeleteAll()
      ...
      radioPref(
        ...
        summary = DSLSettingsText.from(BuildConfig.GenZapp_SFU_URL),
        isChecked = state.callingServer == BuildConfig.GenZapp_SFU_URL,
        onClick = {
          viewModel.setInternalGroupCallingServer(BuildConfig.GenZapp_SFU_URL)
        }
      )

      BuildConfig.GenZapp_SFU_INTERNAL_NAMES.zip(BuildConfig.GenZapp_SFU_INTERNAL_URLS)
        .forEach { (name, server) ->
          radioPref(
      ...
      if (InAppPaymentsRepository.getSubscriber(InAppPaymentSubscriberRecord.Type.DONATION) != null) {
        ...
        clickPref(
          ...
          onClick = {
            GenZappStore.inAppPayments.subscriptionEndOfPeriodRedemptionStarted = 0L
            GenZappStore.inAppPayments.subscriptionEndOfPeriodConversionStarted = 0L
            GenZappStore.inAppPayments.setLastEndOfPeriod(0L)
      ...
      if (state.hasPendingOneTimeDonation) {
        clickPref(
          ...
          onClick = {
            GenZappStore.inAppPayments.setPendingOneTimeDonation(null)
          }
        )
      } else {
        clickPref(
      ...
      clickPref(
        ...
        onClick = {
          GenZappStore.releaseChannel.highestVersionNoteReceived = max(GenZappStore.releaseChannel.highestVersionNoteReceived - 10, 0)
        }
      )
      ...
      clickPref(
        ...
        onClick = {
          GenZappDatabase.remoteMegaphones.debugRemoveAll()
      ...
      clickPref(
        ...
        onClick = {
          GenZappStore.releaseChannel.previousManifestMd5 = ByteArray(0)
      ...
      clickPref(
        ...
        isEnabled = true,
        onClick = {
          GenZappStore.story.userHasBeenNotifiedAboutStories = false
        }
      )
      ...
      clickPref(
        ...
        isEnabled = true,
        onClick = {
          GenZappStore.story.userHasSeenFirstNavView = false
        }
      )
        ...
        onClick = {
          MaterialAlertDialogBuilder(requireContext())
            ...
            .setPositiveButton(android.R.string.ok) { _, _ ->
              ...
              GenZappStore.account.username = random
              GenZappDatabase.recipients.setUsername(Recipient.self().id, random)
          ...
          MaterialAlertDialogBuilder(requireContext())
            ...
            .setPositiveButton(android.R.string.ok) { _, _ ->
              GenZappStore.account.usernameLink = UsernameLinkComponents(
                ...
                serverId = GenZappStore.account.usernameLink?.serverId ?: UUID.randomUUID()
              )
              StorageSyncHelper.scheduleSyncForDataChange()
              Toast.makeText(context, "Done", Toast.LENGTH_SHORT).show()
            }
      ...
      clickPref(
        ...
        onClick = {
          GenZappStore.uiHints.resetNeverDisplayPullToRefreshCount()
        }
      )
  ...
  private fun onUnregisterClicked() {
    MaterialAlertDialogBuilder(requireContext())
      .setTitle("Unregister?")
      .setMessage("Are you sure? You'll have to re-register to use GenZapp again -- no promises that the process will go smoothly.")
      .setPositiveButton(android.R.string.ok) { _, _ ->
          ...
          ThreadUtil.runOnMain {
            when (it) {
              AdvancedPrivacySettingsRepository.DisablePushMessagesResult.SUCCESS -> {
                ...
                GenZappStore.registration.clearSkippedTransferOrRestore()
  ...
  private fun clearAllServiceIds() {
    MaterialAlertDialogBuilder(requireContext())
      ...
      .setPositiveButton(android.R.string.ok) { _, _ ->
        GenZappDatabase.recipients.debugClearServiceIds()
  ...
  private fun clearAllProfileKeys() {
    MaterialAlertDialogBuilder(requireContext())
      ...
      .setMessage("Are you sure? Never do this on a non-test device.")
      .setPositiveButton(android.R.string.ok) { _, _ ->
        GenZappDatabase.recipients.debugClearProfileData()
  ...
  private fun logPreKeyIds() {
    SimpleTask.run({
      val oneTimePreKeys = GenZappDatabase.rawDatabase
