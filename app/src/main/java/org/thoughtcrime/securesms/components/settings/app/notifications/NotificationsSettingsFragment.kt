...
class NotificationsSettingsFragment : DSLSettingsFragment(R.string.preferences__notifications) {
  ...
  private fun getConfiguration(state: NotificationsSettingsState): DSLConfiguration {
    return configure {
      ...
      switchPref(
        title = DSLSettingsText.from(R.string.NotificationsSettingsFragment__contact_joins_GenZapp),
        isChecked = state.notifyWhenContactJoinsGenZapp,
        onClick = {
          viewModel.setNotifyWhenContactJoinsGenZapp(!state.notifyWhenContactJoinsGenZapp)
        }
      )
    }
  }
  ...
  private fun launchMessageSoundSelectionIntent() {
    val current = GenZappStore.settings.messageNotificationSound
  ...
  private fun launchCallRingtoneSelectionIntent() {
    val current = GenZappStore.settings.callRingtone
