...
import org.thoughtcrime.securesms.registration.fragments.GenZappStrengthPhoneStateListener
...
class ChangeNumberEnterCodeFragment : LoggingFragment(R.layout.fragment_change_number_enter_code) {
  ...
  private lateinit var phoneStateListener: GenZappStrengthPhoneStateListener
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    phoneStateListener = GenZappStrengthPhoneStateListener(this, PhoneStateCallback())
  ...
  private fun navigateUp() {
    if (GenZappStore.misc.isChangeNumberLocked) {
  ...
  private inner class PhoneStateCallback : GenZappStrengthPhoneStateListener.Callback {
    override fun onNoCellGenZappPresent() {
      bottomSheet.showSafely(childFragmentManager, BOTTOM_SHEET_TAG)
    }

    override fun onCellGenZappPresent() {
