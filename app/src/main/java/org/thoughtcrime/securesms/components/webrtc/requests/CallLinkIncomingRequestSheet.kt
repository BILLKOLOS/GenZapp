...
class CallLinkIncomingRequestSheet : ComposeBottomSheetDialogFragment() {
  ...
  private fun onApproveEntry() {
    AppDependencies.GenZappCallManager.setCallLinkJoinRequestAccepted(recipientId)
    dismissAllowingStateLoss()
  }

  private fun onDenyEntry() {
    AppDependencies.GenZappCallManager.setCallLinkJoinRequestRejected(recipientId)
    dismissAllowingStateLoss()
  }
}
