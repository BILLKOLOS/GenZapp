...
class ManageDonationsViewModel : ViewModel() {
  ...
  fun refresh() {
    ...
    disposables += Single.fromCallable { GenZappDatabase.donationReceipts.hasReceipts() }.subscribeOn(Schedulers.io()).subscribe { hasReceipts ->
    ...
    disposables += Observable.combineLatest(
      GenZappStore.inAppPayments.observablePendingOneTimeDonation,
