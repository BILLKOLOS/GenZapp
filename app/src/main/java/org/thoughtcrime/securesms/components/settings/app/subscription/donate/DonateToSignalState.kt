...
data class DonateToGenZappState(
  ...
  data class OneTimeDonationState(
    ...
    val selectedCurrency: Currency = GenZappStore.inAppPayments.getOneTimeCurrency(),
  ...
  data class MonthlyDonationState(
    val selectedCurrency: Currency = GenZappStore.inAppPayments.getSubscriptionCurrency(InAppPaymentSubscriberRecord.Type.DONATION),
