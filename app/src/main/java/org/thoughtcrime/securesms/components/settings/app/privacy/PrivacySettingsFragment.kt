...
class PrivacySettingsFragment : DSLSettingsFragment(R.string.preferences__privacy) {
  ...
  private val incognitoSummary: CharSequence by lazy {
    SpannableStringBuilder(getString(R.string.preferences__this_setting_is_not_a_guarantee))
      .append(" ")
      .append(
        SpanUtil.learnMore(requireContext(), ContextCompat.getColor(requireContext(), R.color.GenZapp_text_primary)) {
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    val promptInfo = PromptInfo.Builder()
      ...
      .setTitle(requireContext().getString(R.string.BiometricDeviceAuthentication__GenZapp))
    ...
    return configure {
      ...
      if (state.isObsoletePasswordEnabled) {
        switchPref(
          ...
          summary = DSLSettingsText.from(R.string.preferences__lock_GenZapp_and_message_notifications_with_a_passphrase),
          isChecked = true,
          onClick = {
            MaterialAlertDialogBuilder(requireContext()).apply {
              setTitle(R.string.ApplicationPreferencesActivity_disable_passphrase)
              setMessage(R.string.ApplicationPreferencesActivity_this_will_permanently_unlock_GenZapp_and_message_notifications)
        ...
        switchPref(
          ...
          summary = DSLSettingsText.from(R.string.preferences__auto_lock_GenZapp_after_a_specified_time_interval_of_inactivity),
        ...
        switchPref(
          ...
          summary = DSLSettingsText.from(R.string.preferences_app_protection__lock_GenZapp_access_with_android_screen_lock_or_fingerprint),
      ...
      switchPref(
        ...
        onClick = {
          if (!ServiceUtil.getKeyguardManager(requireContext()).isKeyguardSecure) {
            ...
            biometricAuth.authenticate(requireContext(), true) { biometricDeviceLockLauncher.launch(getString(R.string.BiometricDeviceAuthentication__GenZapp)) }
          } else {
      ...
      clickPref(
        ...
        summary = DSLSettingsText.from(R.string.PrivacySettingsFragment__GenZapp_message_and_calls),
        onClick = {
