  ...
  Scaffold(
    topBar = {
      TopAppBar(
        ...
        colors = if (listState.canScrollBackward) TopAppBarDefaults.topAppBarColors(containerColor = GenZappTheme.colors.colorSurface2) else TopAppBarDefaults.topAppBarColors()
      )
    }
  ) {
