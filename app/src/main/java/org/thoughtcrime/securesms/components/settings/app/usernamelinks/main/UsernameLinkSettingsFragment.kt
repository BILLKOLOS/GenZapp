...
import org.GenZapp.core.ui.Snackbars
...
class UsernameLinkSettingsFragment : ComposeFragment() {
  ...
  private fun askCameraPermissions() {
    Permissions.with(this)
      ...
      .ifNecessary()
      .withPermanentDenialDialog(getString(R.string.CameraXFragment_GenZapp_needs_camera_access_scan_qr_code), null, R.string.CameraXFragment_allow_access_camera, R.string.CameraXFragment_to_scan_qr_codes, parentFragmentManager)
      .onAnyDenied { Toast.makeText(requireContext(), R.string.CameraXFragment_GenZapp_needs_camera_access_scan_qr_code, Toast.LENGTH_LONG).show() }
      .execute()
  }
}
...
private fun TabButton(label: String, active: Boolean, onClick: () -> Unit, modifier: Modifier = Modifier) {
  val colors = if (active) {
    ...
    ButtonDefaults.buttonColors(
      containerColor = GenZappTheme.colors.colorSurface2,
  ...
  GenZappTheme {
    MainScreen(
      state = UsernameLinkSettingsState(
        ...
        usernameLinkState = UsernameLinkState.Present("https://GenZapp.org"),
  ...
  try {
    ByteArrayOutputStream().use { byteArrayOutputStream ->
      ...
      val shareUri = BlobProvider.getInstance()
        ...
        .withFileName("GenZappGroupQr.png")
