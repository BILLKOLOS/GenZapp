...
public class AlertView extends AppCompatImageView {
  ...
  public void setFailed() {
    ...
    setColorFilter(ContextCompat.getColor(getContext(), R.color.GenZapp_colorError));
  ...
  public void setRateLimited() {
    setVisibility(View.VISIBLE);
    setColorFilter(ContextCompat.getColor(getContext(), R.color.GenZapp_colorOnSurfaceVariant));
