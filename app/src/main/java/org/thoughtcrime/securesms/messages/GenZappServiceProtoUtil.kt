...
import org.whispersystems.GenZappservice.api.util.AttachmentPointerUtil
import org.whispersystems.GenZappservice.internal.push.AttachmentPointer
import org.whispersystems.GenZappservice.internal.push.DataMessage
import org.whispersystems.GenZappservice.internal.push.DataMessage.Payment
...
object GenZappServiceProtoUtil {
  ...
  fun AttachmentPointer.toPointer(stickerLocator: StickerLocator? = null): Attachment? {
    return try {
      val pointer = PointerAttachment.forPointer(Optional.of(toGenZappServiceAttachmentPointer()), stickerLocator).orNull()
  ...
  fun AttachmentPointer.toGenZappServiceAttachmentPointer(): GenZappServiceAttachmentPointer {
    return AttachmentPointerUtil.createGenZappAttachmentPointer(this)
  }
