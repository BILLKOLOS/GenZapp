...
import org.whispersystems.GenZappservice.internal.push.TextAttachment
...
object StoryMessageProcessor {
  ...
  fun process(envelope: Envelope, content: Content, metadata: EnvelopeMetadata, senderRecipient: Recipient, threadRecipient: Recipient) {
    ...
    if (threadRecipient.isGroup && !GenZappDatabase.groups.isCurrentMember(threadRecipient.requireGroupId().requirePush(), senderRecipient.id)) {
