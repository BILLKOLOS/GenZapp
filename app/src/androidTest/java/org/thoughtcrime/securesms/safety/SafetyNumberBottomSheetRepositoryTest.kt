...
class SafetyNumberBottomSheetRepositoryTest {
  ...
  fun givenIHaveADistributionListDestination_whenIGetBuckets_thenIOnlyHaveDistributionListDestinationWithCorrespondingMembers() {
    ...
    val distributionList = GenZappDatabase.distributionLists.createList("ListA", distributionListMembers)!!
    val destinationKey = ContactSearchKey.RecipientSearchKey(GenZappDatabase.distributionLists.getRecipientId(distributionList)!!, true)
