...
class ContactRecordProcessorTest {
  ...
  fun process_splitContact_normalSplit_twoRecords() {
    // GIVEN
    val originalId = GenZappDatabase.recipients.getAndPossiblyMerge(ACI_A, PNI_A, E164_A)
  ...
  private fun buildRecord(id: StorageId, record: ContactRecord): GenZappContactRecord {
    return GenZappContactRecord(id, record)
  }
