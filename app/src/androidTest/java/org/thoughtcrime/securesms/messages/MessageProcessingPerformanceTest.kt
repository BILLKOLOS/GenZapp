...
import org.whispersystems.GenZappservice.internal.websocket.WebSocketMessage
import org.whispersystems.GenZappservice.internal.websocket.WebSocketRequestMessage
  ...
  private fun Envelope.toWebSocketPayload(): ByteString {
    return WebSocketMessage(
      ...
      request = WebSocketRequestMessage(
        ...
        headers = listOf("X-GenZapp-Timestamp: ${this.timestamp}"),
