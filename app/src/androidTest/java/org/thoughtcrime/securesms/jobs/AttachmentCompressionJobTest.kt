...
class AttachmentCompressionJobTest {
  ...
  fun testCompressionJobsWithDifferentTransformPropertiesCompleteSuccessfully() {
    ...
    val firstDatabaseAttachment = GenZappDatabase.attachments.insertAttachmentForPreUpload(firstPreUpload)
    ...
    val secondDatabaseAttachment = GenZappDatabase.attachments.insertAttachmentForPreUpload(secondPreUpload)
